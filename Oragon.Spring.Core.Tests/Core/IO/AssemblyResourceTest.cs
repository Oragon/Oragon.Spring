...
namespace Oragon.Spring.Core.IO
{
    ...
    public class AssemblyResourceTest
    {
        ...
        {
            Assert.Throws<UriFormatException>(() => new AssemblyResource("assembly://Oragon.Spring.Core.Tests,Oragon.Spring.TestResource.txt"));
        }
        ...
        {
            IResource res = new AssemblyResource("assembly://Oragon.Spring.Core.Tests/Spring/TestResource.txt");
            IResource res2 = res.CreateRelative("Oragon.Spring.Core.Tests/Oragon.Spring.Core.IO/TestResource.txt");
            AssertResourceContent(res2, "Oragon.Spring.Core.IO.TestResource.txt");
        }
        ...
        /// the default namespace of the Oragon.Spring.Core.Tests project is
        /// 'Spring'.  The notation './IO/TestResource.txt' will navigate
        /// down to the 'Oragon.Spring.Core.IO' namespace and CreateRelative will
        ...
        /// The first resource is physically located in the root of the project since
        /// the default namespace of the Oragon.Spring.Core.Tests project is
        /// 'Spring'.  The notation '/Oragon.Spring.Core.IO/TestResource.txt' will navigate
        /// down to the 'Oragon.Spring.Core.IO' namespace and CreateRelative will
        /// then retrieve the similarly named TestResource.txt located there.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test creating a resource relative to the location of the first.
        /// The first resource is physically located in the Oragon.Spring.Core.IO directory
        /// of the project and corresponds to the namespace 'Oragon.Spring.Core.IO'.
        ...
        /// <summary>
        /// Test creating a resource relative to the location of the first.
        /// The first resource is physically located in the Oragon.Spring.Core.IO
        /// directory of the project and corresponds to the namespace
        /// 'Oragon.Spring.Core.IO'.  The notation '../../Objects/Factory/TestResource.txt'
        /// will navigate up to the root 'Spring' namespace and then down
        /// into the 'Oragon.Spring.Object.Factory' namespace and CreateRelative
        ...
        /// The file 'abstract.xml' is located under Oragon.Spring.Data in the VS.NET project
        /// but a build-event copies these files under the location
        /// of Oragon.Spring.Core.Tests.dll.
        /// </summary>
        [Test]
        [Ignore("NOT-WORKING")]
