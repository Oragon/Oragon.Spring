...
namespace Oragon.Spring.Core.TypeResolution
{
    /// <summary>
    ...
    public class GenericTypeResolverTests : TypeResolverTests
    {
        ...
        {
            Type t = GetTypeResolver().Resolve("Oragon.Spring.Objects.TestGenericObject< int, string>");
        ...
        {
            // CLOVER:ON
            Type t = GetTypeResolver().Resolve("Oragon.Spring.Objects.TestGenericObject< ,>");
            // CLOVER:OFF
        ...
        {
            Assert.Throws<TypeLoadException>(() => GetTypeResolver().Resolve("Oragon.Spring.Objects.TestGenericObject<int >"));
        }
        ...
        {
            Assert.Throws<TypeLoadException>(() => GetTypeResolver().Resolve("Oragon.Spring.Objects.TestGenericObject<System.Collections.Generic.Stack<int>, System, string>"));
        }

        [Test]
        public void ResolveMalformedGenericType()
        {
            Assert.Throws<TypeLoadException>(() => GetTypeResolver().Resolve("Oragon.Spring.Objects.TestGenericObject<int, <string>>"));
        }

        [Test]
        public void ResolveNestedGenericTypeWithAssemblyName()
        {
            Type t = GetTypeResolver().Resolve("System.Collections.Generic.Stack< Oragon.Spring.Objects.TestGenericObject<int, string> >, System");
            Assert.AreEqual(typeof(System.Collections.Generic.Stack<Oragon.Spring.Objects.TestGenericObject<int, string>>), t);
        }

        [Test]
        public void ResolveClrNotationStyleGenericTypeWithAssemblyName()
        {
            Type t = GetTypeResolver().Resolve("System.Collections.Generic.Stack`1[ [Oragon.Spring.Objects.TestGenericObject`2[int, string], Oragon.Spring.Core.Tests] ], System");
            Assert.AreEqual(typeof(System.Collections.Generic.Stack<Oragon.Spring.Objects.TestGenericObject<int, string>>), t);
        }
        ...
        {
            Type t = GetTypeResolver().Resolve("System.Collections.Generic.Stack< [Oragon.Spring.Objects.TestGenericObject<int, string>, Oragon.Spring.Core.Tests] >, System");
            Assert.AreEqual(typeof(System.Collections.Generic.Stack<Oragon.Spring.Objects.TestGenericObject<int, string>>), t);
        }
    }
}
