...
namespace Oragon.Spring.Core.TypeResolution
{
    ...
    public sealed class TypeResolutionUtilsTests
    {
        ...
        {
            Type testObjectType = TypeResolutionUtils.ResolveType("Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.Tests");
		...
		{
            Assert.Throws<TypeLoadException>(() => TypeResolutionUtils.ResolveType("Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.FooTests"));
		}

        [Test]
        public void ResolveFromShortName()
        {
            Type testObjectType = TypeResolutionUtils.ResolveType("Oragon.Spring.Objects.TestObject");
            Assert.IsNotNull(testObjectType);
			Assert.IsTrue(testObjectType.Equals(typeof (TestObject)));
        }
		...
		{
            Assert.Throws<TypeLoadException>(() => TypeResolutionUtils.ResolveType("Oragon.Spring.Objects.FooBarTestObject"));
		}
