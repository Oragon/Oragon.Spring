...
namespace Oragon.Spring.Proxy
{
    ...
    public sealed class InheritanceProxyTypeBuilderTests : AbstractProxyTypeBuilderTests
    {
        ...
        public void ImplementFinalMethodThatImplementsInterface()
        {
            ...
            MethodInfo method = ReflectionUtils.GetMethod(proxy, "Oragon.Spring.Proxy.ITargetObjectTest.InterfaceMethodWithArguments", new Type[] { typeof(string) });
        ...
        public void DoesNotProxyNonProxiableInterface()
        {
            ...
            Assert.IsNotNull(foo.GetType().GetMethod("Oragon.Spring.Proxy.IApplicationInterface.ApplicationMethod", BindingFlags.Instance | BindingFlags.NonPublic));

            // proxy implements IFrameworkInterface but should not proxy methods
            Assert.IsNull(foo.GetType().GetMethod("Oragon.Spring.Proxy.IFrameworkInterface.FrameworkMethod", BindingFlags.Instance | BindingFlags.NonPublic));
        }
        ...
        public void ForcesNonProxiableInterfacesToBeProxied()
        {
            ...
            Assert.IsNotNull(foo.GetType().GetMethod("Oragon.Spring.Proxy.IFrameworkInterface.FrameworkMethod", BindingFlags.Instance | BindingFlags.NonPublic));

            // proxy implements IApplicationInterface but should not proxy methods
            Assert.IsNull(foo.GetType().GetMethod("Oragon.Spring.Proxy.IApplicationInterface.ApplicationMethod", BindingFlags.Instance | BindingFlags.NonPublic));
        }
