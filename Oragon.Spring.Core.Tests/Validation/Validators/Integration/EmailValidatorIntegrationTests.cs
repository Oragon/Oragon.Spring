...
namespace Oragon.Spring.Validation.Validators
{
    /// <summary>
    ...
    public class EmailValidatorIntegrationTests
    {
        ...
        public void EmailValidatorTests()
        {
            ...
            <objects xmlns='http://www.springframework.net' xmlns:v='http://www.springframework.net/validation'>
                <v:validator id='emailValidator' test='#this' type='Oragon.Spring.Validation.Validators.EmailValidator, Oragon.Spring.Core'/>
            </objects>";
