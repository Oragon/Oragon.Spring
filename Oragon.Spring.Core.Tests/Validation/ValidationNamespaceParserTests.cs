...
using Oragon.Spring.Validation.Config;
...
namespace Oragon.Spring.Validation
{
    ...
    public sealed class ValidationNamespaceParserTests
    {
        ...
        {
            AssemblyResource validationSchema = new AssemblyResource("assembly://Oragon.Spring.Core/Oragon.Spring.Validation.Config/spring-validation-1.3.xsd");
            AssemblyResource objectsSchema = new AssemblyResource("assembly://Oragon.Spring.Core/Oragon.Spring.Objects.Factory.Xml/spring-objects-1.3.xsd");
...
//        <v:action type='Oragon.Spring.Validation.Actions.ExpressionAction, Oragon.Spring.Core' when='true'/>
//    </v:required>
//</objects>
//";
