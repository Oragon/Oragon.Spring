...
using Oragon.Spring.Expressions.Parser.antlr.collections;
using Oragon.Spring.Expressions.Processors;
...
namespace Oragon.Spring.Expressions
{
    ...
    public sealed class ExpressionEvaluatorTests
    {
        ...
        public void AllExpressionNodeTypesAreSerializable()
        {
            ...
            // look for all BaseNode derived types defined in assembly Oragon.Spring.Core
        ...
        public void TestTypeNode()
        {
            ...
            Assert.AreEqual(typeof(ExpressionEvaluator), ExpressionEvaluator.GetValue(null, "T(Oragon.Spring.Expressions.ExpressionEvaluator, Oragon.Spring.Core)"));
...
//            Assert.AreEqual(typeof(int?), ExpressionEvaluator.GetValue(null, "T(System.Nullable`1[[System.Int32, mscorlib]], mscorlib)"));
        ...
        {
            ContextRegistry.RegisterContext(new XmlApplicationContext(false, "assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Context.Support/objects.xml"));
