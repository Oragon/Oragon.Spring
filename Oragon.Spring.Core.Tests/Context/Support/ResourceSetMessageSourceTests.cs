...
//        private const string ResourceNamespace = "Oragon.Spring.Resources";
//        private const string ResourceFileName = "Oragon.Spring.Context.Tests";
...
//            Assert.AreEqual("ResourceSetMessageSource with ResourceManagers of base names = [Oragon.Spring.Resources.Oragon.Spring.Context.Tests]",
...
//                Assert.AreEqual("Ovo je Oragon.Spring.NET",
...
//                Assert.AreEqual("Ово је Oragon.Spring.NET",
...
//                Assert.AreEqual("Visual Studio voli Oragon.Spring.NET",
...
//            Assembly ass = Assembly.Load("Oragon.Spring.Core.Tests");
...
//        {
//            messageSource.ResourceManagers = resourceManagerList;
//            Assert.AreEqual("This is Oragon.Spring.NET", messageSource.GetMessage("MyMessage", CultureInfo.InvariantCulture, new object[] { "Spring", ".NET" }), "message");
//            Assert.AreEqual("Visual Studio loves Oragon.Spring.NET", messageSource.GetMessage("MyNewMessage", CultureInfo.InvariantCulture, "Spring", ".NET"), "message");
//            Assert.AreEqual("This is Oragon.Spring.NET", messageSource.GetMessage("MyMessage", CultureInfo.InvariantCulture, new object[] { "Spring", ".NET" }), "message");
//        }
...
//            Assert.AreEqual("This is Oragon.Spring.NET",
