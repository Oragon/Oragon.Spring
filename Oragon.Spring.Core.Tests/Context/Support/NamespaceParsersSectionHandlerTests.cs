...
<parsers>
	<parser namespace='http://schemas.springframework.net/testobject' type='Oragon.Spring.Context.Support.TestObjectConfigParser, Oragon.Spring.Core.Tests' schemaLocation='assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Context.Support/testobject.xsd'/>
		...
		public void ParseSectionWithHandlerThatDoesNotImplement_IXmlObjectDefinitionParser()
		{
			const string xml = @"<?xml version='1.0' encoding='UTF-8' ?>
<parsers>
	<parser namespace='http://schemas.springframework.net/2' type='Oragon.Spring.Context.Support.NamespaceParsersSectionHandlerTests, Oragon.Spring.Core.Tests' schemaLocation='assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Context.Support/testobject.xsd'/>
</parsers>";
		...
		public void ParseSectionWithBadTypeForHandler()
		{
			const string xml = @"<?xml version='1.0' encoding='UTF-8' ?>
<parsers>
	<parser namespace='http://schemas.springframework.net/2' type='Rubbish' schemaLocation='assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Context.Support/testobject.xsd'/>
</parsers>";
