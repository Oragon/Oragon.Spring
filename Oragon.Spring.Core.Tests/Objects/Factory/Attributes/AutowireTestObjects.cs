...
namespace Oragon.Spring.Objects.Factory.Attributes.ByType
{
...
namespace Oragon.Spring.Objects.Factory.Attributes.ByQualifier
{
    public class AutowireTestFieldNormal
    {
        [Autowired]
...
namespace Oragon.Spring.Objects.Factory.Attributes.ByQualifierAttribute
{
...
namespace Oragon.Spring.Objects.Factory.Attributes.ByValue
{
    public class AutowireTestFieldNormal
    {
        [Value("@(CiaoFoo)")]
...
namespace Oragon.Spring.Objects.Factory.Attributes.Collections
{
    ...
    {
        [Autowired]
        public Oragon.Spring.Collections.Generic.ISet<IFoo> foos;        
    }
