...
using Oragon.Spring.Objects.Factory.Attributes.ByValue;
...
namespace Oragon.Spring.Objects.Factory.Attributes
{
    ...
    public class AutowireByValueTests
    {
        ...
        public void Setup()
        {
            _applicationContext = new XmlApplicationContext(false, "assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Objects.Factory.Attributes/ByValueObjects.xml");
