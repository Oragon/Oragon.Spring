    ...
    public class RequiredAttributeObjectPostProcessorTests
    {
            ...
            try
            {
                XmlApplicationContext ctx =
                    new XmlApplicationContext(false,
                                              "assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Objects.Factory.Attributes/RequiredWithOneRequiredPropertyOmitted.xml");
        ...
        public void WithThreeRequiredPropertiesOmitted()
        {
            try
            {
                XmlApplicationContext ctx =
                       new XmlApplicationContext(false,
                                                 "assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Objects.Factory.Attributes/RequiredWithThreeRequiredPropertiesOmitted.xml");
                Assert.Fail("Should have thrown ObjectCreationException");
            }
            catch (ObjectCreationException ex)
            {
        ...
        public void WithOnlyRequiredPropertiesSpecified()
        {
            XmlApplicationContext ctx =
                      new XmlApplicationContext(false,
                                                "assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Objects.Factory.Attributes/RequiredWithAllRequiredPropertiesProvided.xml");
        ...
        public void WithCustomAttribute()
        {
            try
            {
                XmlApplicationContext ctx =
                       new XmlApplicationContext(false,
                                                 "assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Objects.Factory.Attributes/RequiredWithCustomAttribute.xml");
                Assert.Fail("Should have thrown ObjectCreationException");
            }
            catch (ObjectCreationException ex)
            {
