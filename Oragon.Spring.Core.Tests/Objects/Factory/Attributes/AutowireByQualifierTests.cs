...
using AutowireTestConstructorNormal = Oragon.Spring.Objects.Factory.Attributes.ByQualifier.AutowireTestConstructorNormal;
using AutowireTestFieldNormal = Oragon.Spring.Objects.Factory.Attributes.ByQualifier.AutowireTestFieldNormal;
using AutowireTestMethodNormal = Oragon.Spring.Objects.Factory.Attributes.ByQualifier.AutowireTestMethodNormal;
using AutowireTestPropertyNormal = Oragon.Spring.Objects.Factory.Attributes.ByQualifier.AutowireTestPropertyNormal;
    ...
    public class AutowireByQualifierTests
    {
        ...
        public void Setup()
        {
            _applicationContext = new XmlApplicationContext(false,
                                                            "assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Objects.Factory.Attributes/ByQualifierObjects.xml");
        }
