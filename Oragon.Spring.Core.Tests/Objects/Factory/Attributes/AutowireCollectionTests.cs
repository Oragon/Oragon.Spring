...
using Oragon.Spring.Objects.Factory.Attributes.Collections;
    ...
    public class AutowireCollectionTests
    {
        ...
        public void Setup()
        {
            _applicationContext = new XmlApplicationContext(false,
                                                            "assembly://Oragon.Spring.Core.Tests/Oragon.Spring.Objects.Factory.Attributes/CollectionObjects.xml");
        }
