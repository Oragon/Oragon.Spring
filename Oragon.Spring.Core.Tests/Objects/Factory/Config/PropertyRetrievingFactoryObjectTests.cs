...
namespace Oragon.Spring.Objects.Factory.Config
{
	...
	public sealed class PropertyRetrievingFactoryObjectTests
	{
		...
		{
			PropertyRetrievingFactoryObject fac = new PropertyRetrievingFactoryObject();
			fac.StaticProperty = "Oragon.Spring.Objects.Factory.Config.PropertyObject.StaticProperty.Item, Oragon.Spring.Core.Tests";
		...
		{
			PropertyRetrievingFactoryObject fac = new PropertyRetrievingFactoryObject();
			fac.StaticProperty = "Oragon.Spring.Objects.Factory.Config.PropertyObject.Age, Oragon.Spring.Core.Tests";
			fac.AfterPropertiesSet();
			Assert.AreEqual(typeof (int), fac.ObjectType);
			object actual = fac.GetObject();
			Assert.AreEqual(PropertyObject.Age, actual);
