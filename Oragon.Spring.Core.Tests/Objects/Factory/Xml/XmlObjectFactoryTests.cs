...
<objects xmlns='http://www.springframework.net' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'
	...
	<object id='foo' type='Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.Tests'>
...
<objects xmlns='http://www.springframework.net' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'
	xsi:schemaLocation='http://www.springframework.net http://www.springframework.net/xsd/spring-objects.xsd'>
	<object id='factory' type='Oragon.Spring.Objects.Factory.Support.TestObjectFactory, Oragon.Spring.Core.Tests'>
		<lookup-method name='GetObject' object='target'/>
	</object>
	<object id='target' type='Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.Tests' singleton='false'>
...
<objects xmlns='http://www.springframework.net' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'
    ...
    <object id='foo' type='Oragon.Spring.Objects.Factory.Config.MethodInvokingFactoryObject'>
        <property name='TargetType' value='Oragon.Spring.Objects.TestObject'/>
...
<objects xmlns='http://www.springframework.net' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'
	xsi:schemaLocation='http://www.springframework.net http://www.springframework.net/xsd/spring-objects.xsd'>
	<object id='golyadkin' type='Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.Tests'>
...
<objects xmlns='http://www.springframework.net' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'
	xsi:schemaLocation='http://www.springframework.net http://www.springframework.net/xsd/spring-objects.xsd'>
	<object id='mother' abstract='true' type='Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.Tests'/>
	<object parent='mother'/>
        ...
        public void InnerObjects()
        {
            ...
            Assert.AreEqual("Oragon.Spring.Objects.TestObject#", inner1.ObjectName.Substring(0, inner1.ObjectName.IndexOf("#")+1));            
            ...
            Assert.AreEqual("Oragon.Spring.Objects.DerivedTestObject#", inner2.ObjectName.Substring(0, inner2.ObjectName.IndexOf("#") + 1));      
	...
	<object id='foo' type='Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.Tests'>
        <property name='spouse'>
            <object
                ...
                type='Oragon.Spring.Objects.Factory.Xml.TestObjectCreator, Oragon.Spring.Core.Tests'/>
        </property>
    </object>
</objects>";
            stream = new MemoryStream(Encoding.UTF8.GetBytes(xml));
...
<objects xmlns='http://www.springframework.net' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'
    ...
    <object id='creator' type='Oragon.Spring.Objects.Factory.Xml.TestObjectCreator, Oragon.Spring.Core.Tests'/>
</objects>";
            stream = new MemoryStream(Encoding.UTF8.GetBytes(xml));
            IObjectFactory factory = new XmlObjectFactory(new InputStreamResource(stream, string.Empty));
            factory.GetObject("foo");
