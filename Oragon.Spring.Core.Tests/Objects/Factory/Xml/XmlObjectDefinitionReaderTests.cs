...
using Oragon.Spring.Aop.Config;
...
namespace Oragon.Spring.Objects.Factory.Xml
{
    ...
    public class XmlObjectDefinitionReaderTests
    {
        ...
        [Test]
        [Ignore("this test cannot co-exist with AutoRegistersAllWellknownNamespaceParsers b/c that test will have already loaded the Oragon.Spring.Data ass'y")]
...
<objects xmlns='http://www.springframework.net'>  
	...
	<object id='test3' type='Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.Tests'>
        ...
        public void ThrowsObjectDefinitionStoreExceptionOnValidationError()
        {
            try
            {
                ...
                reader.LoadObjectDefinitions(new StringResource(
                                                @"<?xml version='1.0' encoding='UTF-8' ?>
                                                <objects xmlns='http://www.springframework.net'>  
	                                                <INVALIDELEMENT id='test2' type='Oragon.Spring.Objects.TestObject, Oragon.Spring.Core.Tests' />
                                                </objects>
                                                "));
                Assert.Fail();
            }
