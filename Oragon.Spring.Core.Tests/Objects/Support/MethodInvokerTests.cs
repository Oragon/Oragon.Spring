...
namespace Oragon.Spring.Objects.Support
{
    ...
    public sealed class MethodInvokerTests
    {
        ...
        public void InvokeWithGenericStaticMethod()
        {
            ...
            mi.TargetMethod = "CreateInstance<Oragon.Spring.Objects.TestObject>";
            mi.Prepare();
            object actual = mi.Invoke();
            Assert.IsNotNull(actual);
        ...
        public void InvokeWithNamedArgumentThatDoesNotExist()
        {
            ...
            Assert.Throws<ArgumentException>(() => vkr.Prepare(), "The named argument 'southpaw' could not be found on the 'GrowOlder' method of class [Oragon.Spring.Objects.Support.MethodInvokerTests+Foo].");
        }
