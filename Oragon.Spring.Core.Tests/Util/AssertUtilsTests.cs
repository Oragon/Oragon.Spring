...
namespace Oragon.Spring.Util
{
    ...
    public sealed class AssertUtilsTests
    {
        ...
        public void UnderstandsMethod()
        {
            ...
            AssertNotUnderstandsMethod(null, "target", getDescriptionMethod, typeof(NotSupportedException), "Target 'target' is null and target method 'Oragon.Spring.Objects.ITestObject.GetDescription' is not static.");
            ...
            // incompatible target, instance method
                AssertNotUnderstandsMethod(new object(), "target", getDescriptionMethod, typeof(NotSupportedException), "Target 'target' of type 'System.Object' does not support methods of 'Oragon.Spring.Objects.ITestObject'.");
            ...
            AssertNotUnderstandsMethod(incompatibleProxy, "incompatibleProxy", getDescriptionMethod, typeof(NotSupportedException), "Target 'incompatibleProxy' is a transparent proxy that does not support methods of 'Oragon.Spring.Objects.ITestObject'.");
        }
