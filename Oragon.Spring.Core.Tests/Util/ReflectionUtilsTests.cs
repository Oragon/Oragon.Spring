...
namespace Oragon.Spring.Util
{
    ...
    public sealed class ReflectionUtilsTests
    {
        ...
        public void GetSignature()
        {
            ...
            string expected = "Oragon.Spring.Util.ReflectionUtilsObject::Spanglish(System.String,System.Object[])";
        ...
        public void GetMethodWithExplicitInterfaceMethod()
        {
            MethodInfo actual = ReflectionUtils.GetMethod(
                typeof(ExplicitFoo),
                "Oragon.Spring.Util.IFoo.Spanglish",
                new Type[] { typeof(string), typeof(object[]) });
            Assert.IsNotNull(actual);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => ReflectionUtils.CreateCustomAttribute(GetType()), "[Oragon.Spring.Util.ReflectionUtilsTests] does not derive from the [System.Attribute] class.");
        }
