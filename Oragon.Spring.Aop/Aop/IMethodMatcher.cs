...
{
	/// <summary>
	/// That part of an <see cref="Oragon.Spring.Aop.IPointcut"/> that checks whether a
	/// target method is eligible for advice.
	/// </summary>
	/// <remarks>
	/// <p>
	/// An <see cref="Oragon.Spring.Aop.IMethodMatcher"/> may be evaluated
	...
	/// </p>
	/// <p>
	/// If the value of the <see cref="Oragon.Spring.Aop.IMethodMatcher.IsRuntime"/>
	...
	/// <see cref="Oragon.Spring.Aop.IMethodMatcher.IsRuntime"/> is
	/// <see langword="false"/>, the three argument
	/// <see cref="Oragon.Spring.Aop.IMethodMatcher.Matches(MethodInfo, Type, object[])"/>
	...
	/// <see cref="Oragon.Spring.Aop.IMethodMatcher.Matches(MethodInfo, Type)"/>
	/// method, and the value of it's
	/// <see cref="Oragon.Spring.Aop.IMethodMatcher.IsRuntime"/> property is
	...
	public interface IMethodMatcher
	{
		...
		/// if the <see cref="Oragon.Spring.Aop.IMethodMatcher.IsRuntime"/> property
