...
namespace Oragon.Spring.Aop
{
	...
	/// <remarks>
	/// <note>
	/// This interface is not for use by Oragon.Spring.NET users, but exists rather to
	/// allow for commonality in the support for different types of advice
	/// within the framework.
	/// </note>
	/// <p>
	/// Oragon.Spring.NET AOP is centered on <b>around advice</b> delivered via method
	/// <b>interception</b>, compliant with the AOP Alliance interception API. 
	/// The <see cref="Oragon.Spring.Aop.IAdvisor"/> interface allows support for
	...
	/// <seealso cref="Oragon.Spring.Aop.IMethodBeforeAdvice"/>
	/// <seealso cref="Oragon.Spring.Aop.IAfterReturningAdvice"/>
	/// <seealso cref="Oragon.Spring.Aop.IThrowsAdvice"/>
	...
	public interface IAdvisor
	{
		...
		/// advised class obtained from the same Oragon.Spring.NET IoC container.
		/// </p>
		/// <p>
		/// Use <c>singleton</c> and <c>prototype</c> object definitions or
		/// appropriate programmatic proxy creation to ensure that
		/// <see cref="Oragon.Spring.Aop.IAdvisor"/>s have the correct lifecycle model. 
		/// </p>
		/// <note>
