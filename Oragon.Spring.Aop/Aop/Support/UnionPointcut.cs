...
{
	/// <summary> 
	/// A <see cref="Oragon.Spring.Aop.IPointcut"/> union.
	/// </summary>
	/// <remarks>
	/// <p>
	/// Such pointcut unions are tricky, because one cannot simply <c>OR</c>
	/// the respective <see cref="Oragon.Spring.Aop.IMethodMatcher"/>s: one has to
	/// ascertain that each <see cref="Oragon.Spring.Aop.IMethodMatcher"/>'s
	/// <see cref="Oragon.Spring.Aop.IPointcut.TypeFilter"/> is also satisfied.
	/// </p>
	/// </remarks>
    ...
    internal class UnionPointcut : IPointcut
	{
		...
		/// <see cref="Oragon.Spring.Aop.Support.UnionPointcut"/> class.
		/// </summary>
