...
{
	/// <summary> 
	/// Various <see cref="Oragon.Spring.Aop.IPointcut"/> related utility methods.
	/// </summary>
	/// <remarks>
	/// <p>
    ...
    public sealed class Pointcuts
	{
		...
		/// </returns>
		/// <seealso cref="Oragon.Spring.Aop.Support.UnionPointcut"/>
		...
		/// <summary>
		/// Creates an <see cref="Oragon.Spring.Aop.IPointcut"/> that is the
		/// intersection of the two supplied pointcuts.
		/// </summary>
		/// <param name="firstPointcut">The first pointcut.</param>
		/// <param name="secondPointcut">The second pointcut.</param>
		/// <returns>
		/// An <see cref="Oragon.Spring.Aop.IPointcut"/> that is the
		/// intersection of the two supplied pointcuts.
		/// </returns>
		...
		/// </summary>
		/// <param name="pointcut">
		/// The <see cref="Oragon.Spring.Aop.IPointcut"/> to be evaluated.
		/// </param>
		...
		/// <summary>
		/// Are the supplied <see cref="Oragon.Spring.Aop.IPointcut"/>s equal?
		/// </summary>
		/// <param name="firstPointcut">The first pointcut.</param>
		/// <param name="secondPointcut">The second pointcut.</param>
		/// <returns>
		/// <see langword="true"/> if the supplied <see cref="Oragon.Spring.Aop.IPointcut"/>s
		/// are equal.
		/// </returns>
		...
		/// <see cref="Oragon.Spring.Aop.Support.Pointcuts"/> class.
		/// </summary>
		/// <remarks>
		/// <p>
