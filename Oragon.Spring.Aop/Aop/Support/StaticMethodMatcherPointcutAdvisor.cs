...
{
	/// <summary>
	/// Convenient superclass for <see cref="Oragon.Spring.Aop.IAdvisor"/>s that
		...
		: StaticMethodMatcherPointcut, IPointcutAdvisor, IOrdered
	{
		...
		/// <see cref="Oragon.Spring.Aop.Support.StaticMethodMatcherPointcutAdvisor"/>
		/// class.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <summary>
		/// Creates a new instance of the
		/// <see cref="Oragon.Spring.Aop.Support.AbstractRegularExpressionMethodPointcut"/>
		...
		public virtual bool IsPerInstance
		{
			get
			{
				throw new NotSupportedException(
					...
					"not yet supported in Oragon.Spring.NET.");
			}
		}
