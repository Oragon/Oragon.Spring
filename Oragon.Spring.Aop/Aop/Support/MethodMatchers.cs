...
namespace Oragon.Spring.Aop.Support
{
	...
	/// <see cref="Oragon.Spring.Aop.IMethodMatcher"/>s.
	/// </summary>
	/// <remarks>
	/// <p>
	...
	{
		/// <summary>
		/// Creates a new <see cref="Oragon.Spring.Aop.IMethodMatcher"/> that is the
		/// union of the two supplied <see cref="Oragon.Spring.Aop.IMethodMatcher"/>s.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <returns>
		/// A new <see cref="Oragon.Spring.Aop.IMethodMatcher"/> that is the
		/// union of the two supplied <see cref="Oragon.Spring.Aop.IMethodMatcher"/>s
		/// </returns>
		...
		/// <summary>
		/// Creates a new <see cref="Oragon.Spring.Aop.IMethodMatcher"/> that is the
		/// intersection of the two supplied <see cref="Oragon.Spring.Aop.IMethodMatcher"/>s.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <see cref="Oragon.Spring.Aop.Support.MethodMatchers"/> class.
		/// </summary>
		/// <remarks>
		/// <p>
