...
{
	/// <summary>
	/// Simple <seealso cref="Oragon.Spring.Aop.IIntroductionAdvisor"/> implementation that
    ...
    public class DefaultIntroductionAdvisor : IIntroductionAdvisor, ITypeFilter
	{
		...
		/// <see cref="Oragon.Spring.Aop.IAdvisor"/>.
		/// </summary>
		/// <value>
		...
		/// <seealso cref="Oragon.Spring.Aop.IIntroductionAdvisor"/>.
		/// </p>
		/// </remarks>
		/// <exception cref="System.ArgumentException">
		...
		/// advice.
		/// </exception>
		/// <seealso cref="Oragon.Spring.Aop.IIntroductionAdvisor.Interfaces"/>
		/// <exception cref="System.ArgumentException">
		/// If any of the <see cref="Interfaces"/> are not interface <see cref="System.Type"/>.
		/// </exception>
