...
{
	/// <summary> 
	/// <see cref="Oragon.Spring.Aop.IPointcut"/> implementation that matches methods
    ...
    public class AttributeMatchMethodPointcut : StaticMethodMatcherPointcut
	{
		...
		/// <see cref="Oragon.Spring.Aop.Support.AttributeMatchMethodPointcut"/> class.
		/// </summary>
		...
		/// <summary>
		/// Creates a new instance of the
		/// <see cref="Oragon.Spring.Aop.Support.AttributeMatchMethodPointcut"/>
		/// class.
		/// </summary>
		/// <param name="attribute">
		/// The <see cref="System.Attribute"/> to match.
