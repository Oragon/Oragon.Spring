...
{
	/// <summary>
	/// Oragon.Spring.NET's core pointcut abstraction.
	/// </summary>
	/// <remarks>
	/// <p>
	/// A pointcut is composed of <see cref="Oragon.Spring.Aop.ITypeFilter"/>s and
	/// <see cref="Oragon.Spring.Aop.IMethodMatcher"/>s. Both these basic terms and an
	/// <see cref="Oragon.Spring.Aop.IPointcut"/> itself can be combined to build up
