...
{
	/// <summary>
	/// <see cref="Oragon.Spring.Aop.ITargetSource"/> implementation that holds a local
	/// object.
	/// </summary>
	/// <remarks>
	/// <p>
	/// This is the default implementation of the
	/// <see cref="Oragon.Spring.Aop.ITargetSource"/> interface used by the AOP
    ...
    public sealed class SingletonTargetSource : ITargetSource
	{
		...
		/// <see cref="Oragon.Spring.Aop.Target.SingletonTargetSource"/>
