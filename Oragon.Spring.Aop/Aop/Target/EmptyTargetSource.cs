...
{
	/// <summary>
	/// The <see cref="Oragon.Spring.Aop.ITargetSource"/> to be used
	...
	public sealed class EmptyTargetSource : ITargetSource, ISerializable
	{
		...
		/// <remarks>
		/// <p>
		/// The <see cref="Oragon.Spring.Aop.Target.EmptyTargetSource.Empty"/>
		...
		/// <see cref="Oragon.Spring.Aop.ITargetSource"/>.
		/// </summary>
		/// <returns>
		/// A <see cref="System.String"/> that represents the current
		/// <see cref="Oragon.Spring.Aop.ITargetSource"/>.
