...
namespace Oragon.Spring.Aop.Target
{
	/// <summary>
	/// Abstract superclass for pooling <see cref="Oragon.Spring.Aop.ITargetSource"/>s.
	/// </summary>
	/// <remarks>
	/// <p>
	...
	/// <see cref="Oragon.Spring.Aop.Target.AbstractPoolingTargetSource.GetTarget"/> and
	/// <see cref="Oragon.Spring.Aop.Target.AbstractPoolingTargetSource.ReleaseTarget"/>
	/// methods to work with their chosen pool. The
	/// <see cref="Oragon.Spring.Aop.Target.AbstractPrototypeTargetSource.NewPrototypeInstance"/>
	/// method inherited from the
	/// <see cref="Oragon.Spring.Aop.Target.AbstractPrototypeTargetSource"/> base class
	/// can be used to create objects to put in the pool. Subclasses must also
	/// implement some of the monitoring methods from the
	/// <see cref="Oragon.Spring.Aop.Target.PoolingConfig"/> interface. This class
	/// provides the
	/// <see cref="Oragon.Spring.Aop.Target.AbstractPoolingTargetSource.GetPoolingConfigMixin"/>
	/// method to return an <see cref="Oragon.Spring.Aop.IIntroductionAdvisor"/>
		...
		: AbstractPrototypeTargetSource, PoolingConfig, IDisposable, IAdvice
	{
		...
		/// <see cref="Oragon.Spring.Aop.Target.AbstractPoolingTargetSource"/>
		/// class.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <summary>
		/// Gets the <see cref="Oragon.Spring.Aop.Target.PoolingConfig"/> mixin.
		/// </summary>
		/// <returns>
		/// An <see cref="Oragon.Spring.Aop.IIntroductionAdvisor"/> exposing statistics
		...
		/// <see cref="Oragon.Spring.Aop.Target.AbstractPrototypeTargetSource.TargetObjectName"/>
		/// property.
		/// </summary>
		/// <value>
		...
		/// </exception>
		/// <seealso cref="Oragon.Spring.Aop.Target.AbstractPrototypeTargetSource.ObjectFactory"/>
		...
		/// </summary>
		/// <param name="factory">
		/// The owning <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>, in
