...
{
	/// <summary>
	/// Base class for dynamic <see cref="Oragon.Spring.Aop.ITargetSource"/>
	...
	/// <remarks>
	/// <p>
	/// All such <see cref="Oragon.Spring.Aop.ITargetSource"/>s must run in an
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>, as they need to
	/// call the <see cref="Oragon.Spring.Objects.Factory.IObjectFactory.GetObject(string)"/>
		...
		: ITargetSource, IObjectFactoryAware, IInitializingObject
	{
		...
		/// <see cref="Oragon.Spring.Aop.Target.AbstractPrototypeTargetSource"/>
		/// class.
		/// </summary>
		/// <remarks>
		/// <p>
