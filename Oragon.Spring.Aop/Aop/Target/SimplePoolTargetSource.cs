...
using Oragon.Spring.Pool;
using Oragon.Spring.Pool.Support;
...
namespace Oragon.Spring.Aop.Target
{
	...
	/// <see cref="Oragon.Spring.Pool.Support.SimplePool"/>
	/// </summary>
    ...
    public class SimplePoolTargetSource : AbstractPoolingTargetSource, IPoolableObjectFactory
	{
		...
		/// return a different <see cref="Oragon.Spring.Pool.IObjectPool"/> implementation.
		/// </p>
		/// </remarks>
		/// <returns>
		/// An empty <see cref="Oragon.Spring.Pool.IObjectPool"/>.
		/// </returns>
