...
{
	/// <summary>
	/// <see cref="Oragon.Spring.Aop.ITargetSource"/> implementation that uses a
		...
		IThreadLocalTargetSourceStats, IDisposable, IMethodInterceptor
	{
		...
		/// </exception>
		/// <seealso cref="Oragon.Spring.Aop.Target.AbstractPrototypeTargetSource.NewPrototypeInstance"/>
