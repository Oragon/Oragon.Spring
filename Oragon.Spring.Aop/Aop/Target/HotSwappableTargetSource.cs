...
{
	/// <summary>
	/// <see cref="Oragon.Spring.Aop.ITargetSource"/> implementation that caches a
    ...
    public class HotSwappableTargetSource : ITargetSource
	{
		...
		/// <see cref="Oragon.Spring.Aop.Target.HotSwappableTargetSource"/> with the initial target.
		/// </summary>
