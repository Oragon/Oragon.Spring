...
namespace Oragon.Spring.Aop.Framework
{
	...
	/// <see cref="Oragon.Spring.Aop.Framework.AbstractMethodInvocation.InvokeJoinpoint()"/>
    ...
    public abstract class AbstractMethodInvocation : IMethodInvocation
	{
		...
		/// <cref see="Oragon.Spring.Aop.Framework.InterceptorAndDynamicMethodMatcher"/>
		...
		/// <see cref="Oragon.Spring.Aop.Framework.AbstractMethodInvocation"/> class.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <see cref="Oragon.Spring.Aop.Framework.InterceptorAndDynamicMethodMatcher"/>s
		/// that need evaluation at runtime.
		/// <see cref="Oragon.Spring.Aop.IMethodMatcher"/>s included in an
        ...
        /// </returns>
        /// <see cref="Oragon.Spring.Aop.Framework.ReflectiveMethodInvocation.PrepareMethodInvocationForProceed"/>
...
//            }
		...
		/// </exception>
        /// <see cref="Oragon.Spring.Aop.Framework.ReflectiveMethodInvocation.InvokeJoinpoint"/>
		...
		/// <see cref="Oragon.Spring.Aop.Framework.AbstractMethodInvocation.This"/> target
