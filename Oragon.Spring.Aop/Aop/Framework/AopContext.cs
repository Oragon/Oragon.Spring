...
namespace Oragon.Spring.Aop.Framework
{
	...
	/// <see cref="Oragon.Spring.Aop.Framework.AopContext.CurrentProxy"/> property is
	...
	/// </p>
    /// <p>
    /// To expose the current proxy, set the <see cref="Oragon.Spring.Aop.Framework.ProxyConfig.ExposeProxy"/> 
    /// property on the controlling proxy to <see langword="true"/>.
    /// The default value for the <see cref="Oragon.Spring.Aop.Framework.ProxyConfig.ExposeProxy"/> property
	...
	/// application code dependent on usage under AOP and the Oragon.Spring.NET AOP
	/// framework.
	/// </p>
	/// </remarks>
