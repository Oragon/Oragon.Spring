...
namespace Oragon.Spring.Aop.Framework.Adapter
{
    ...
    /// <remarks>
    /// <p>
    /// Implementations of the <see cref="Oragon.Spring.Aop.IThrowsAdvice"/> interface
    ...
    /// need to implement the <see cref="Oragon.Spring.Aop.IThrowsAdvice"/> interface.
    /// Throws advice methods are discovered via reflection... the
    /// <see cref="Oragon.Spring.Aop.IThrowsAdvice"/> interface serves merely to
    ...
    /// directly by Oragon.Spring.NET users.
    /// </p>
    /// </remarks>
    /// <example>
    /// <p>
    /// Find below some examples of valid <see cref="Oragon.Spring.Aop.IThrowsAdvice"/>
    /// method signatures...
    /// </p>
    /// <code language="C#">
    ...
    public sealed class ThrowsAdviceInterceptor : IMethodInterceptor
    {
        ...
        /// <see cref="Oragon.Spring.Aop.Framework.Adapter.ThrowsAdviceInterceptor"/> class.
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="advice">
