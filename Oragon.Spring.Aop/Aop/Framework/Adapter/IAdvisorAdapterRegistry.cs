...
namespace Oragon.Spring.Aop.Framework.Adapter
{
    /// <summary>
    /// A registry of
    /// <see cref="Oragon.Spring.Aop.Framework.Adapter.IAdvisorAdapter"/> instances.
    /// </summary>
    /// <remarks>
    /// <p>
    ...
    public interface IAdvisorAdapterRegistry
    {
        ...
        /// <see cref="Oragon.Spring.Aop.IAdvisor"/>; if it's an
        /// <see cref="Oragon.Spring.Aop.IPointcutAdvisor"/>, just return an
        /// interceptor.
        /// </p>
        /// </remarks>
        /// <param name="advisor">
