...
namespace Oragon.Spring.Aop.Framework.Adapter
{
    ...
    /// wraps <see cref="Oragon.Spring.Aop.IMethodBeforeAdvice"/> instances.
    /// </summary>
    /// <remarks>
    /// <p>
    /// In the future Oragon.Spring.NET may also offer a more efficient alternative
    ...
    /// </p>
    /// <p>
    /// Used internally by the Oragon.Spring.NET AOP framework: application developers
    ...
    internal sealed class MethodBeforeAdviceInterceptor : IMethodInterceptor
    {
        ...
        /// <see cref="Oragon.Spring.Aop.Framework.Adapter.MethodBeforeAdviceInterceptor"/>
        /// class.
        /// </summary>
        /// <param name="advice">
        /// The <see cref="Oragon.Spring.Aop.IMethodBeforeAdvice"/> that is to be wrapped.
        /// </param>
