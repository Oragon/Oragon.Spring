...
namespace Oragon.Spring.Aop.Framework.Adapter
{
	...
	/// types, enabling these advice types to be used in the Oragon.Spring.NET AOP
	/// framework, which uses interception under the covers.
	/// </p>
	/// <p>
	/// There is no need for most Oragon.Spring.NET users to implement this interface;
	/// do so only if you need to introduce more
	/// <see cref="Oragon.Spring.Aop.IAdvisor"/> or <see cref="AopAlliance.Aop.IAdvice"/>
	/// types to Oragon.Spring.NET.
	/// </p>
	/// </remarks>
	...
	public interface IAdvisorAdapter
	{
	    ...
	    /// <see cref="Oragon.Spring.Aop.Framework.Adapter.IAdvisorAdapterRegistry.Wrap"/>
	    /// method with the given advice as an argument?
	    /// </p>
	    /// </remarks>
	    /// <param name="advice">
	    /// <see cref="AopAlliance.Aop.IAdvice"/> such as
	    /// <see cref="Oragon.Spring.Aop.IBeforeAdvice"/>.
	    /// </param>
	    ...
	    /// <remarks>
	    /// <p>
	    /// Don't worry about any <see cref="Oragon.Spring.Aop.IPointcut"/>
	    /// contained in the supplied <see cref="Oragon.Spring.Aop.IAdvisor"/>;
	    /// the AOP framework will take care of checking the pointcut.
	    /// </p>
	    /// </remarks>
	    /// <param name="advisor">
	    /// The advice. The
	    /// <see cref="Oragon.Spring.Aop.Framework.Adapter.IAdvisorAdapter.SupportsAdvice"/>
