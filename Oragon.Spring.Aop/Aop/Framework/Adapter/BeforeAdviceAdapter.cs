...
namespace Oragon.Spring.Aop.Framework.Adapter
{
    ...
    /// to enable <see cref="Oragon.Spring.Aop.IMethodBeforeAdvice"/> to be used in the
    ...
    internal class BeforeAdviceAdapter : IAdvisorAdapter
    {
        ...
        /// <see cref="Oragon.Spring.Aop.IMethodBeforeAdvice"/> interface.
        /// </summary>
        /// <param name="advice">The advice to check.</param>
        /// <returns>
        /// <see langword="true"/> if the supplied <paramref name="advice"/> is
        /// an instance of the <see cref="Oragon.Spring.Aop.IMethodBeforeAdvice"/> interface;
