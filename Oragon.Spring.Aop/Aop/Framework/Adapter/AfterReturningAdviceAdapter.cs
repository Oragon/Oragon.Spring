...
namespace Oragon.Spring.Aop.Framework.Adapter
{
    ...
    /// to enable <see cref="Oragon.Spring.Aop.IAfterReturningAdvice"/> to be used in the
    ...
    internal class AfterReturningAdviceAdapter : IAdvisorAdapter
    {
        ...
        /// <see cref="Oragon.Spring.Aop.IAfterReturningAdvice"/> interface.
        /// </summary>
        /// <param name="advice">The advice to check.</param>
        /// <returns>
        /// <see langword="true"/> if the supplied <paramref name="advice"/> is
        /// an instance of the <see cref="Oragon.Spring.Aop.IAfterReturningAdvice"/> interface;
        ...
        /// <see cref="Oragon.Spring.Aop.Framework.Adapter.AfterReturningAdviceInterceptor"/>
        /// instance.
        /// </summary>
        /// <param name="advisor">
