...
{
    /// <summary>
    /// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectPostProcessor"/> implementation
    /// that registers instances of any non-default
    /// <see cref="Oragon.Spring.Aop.Framework.Adapter.IAdvisorAdapter"/> instances with the
    /// <see cref="Oragon.Spring.Aop.Framework.Adapter.GlobalAdvisorAdapterRegistry"/>
    /// singleton.
    /// </summary>
    /// <remarks>
    /// <p>
    /// The only requirement for it to work is that it needs to be defined
    /// in an application context along with any arbitrary "non-native" Oragon.Spring.NET
    /// <see cref="Oragon.Spring.Aop.Framework.Adapter.IAdvisorAdapter"/> instances that need
    /// to be recognized by Oragon.Spring.NET's AOP framework.
    /// </p>
    /// </remarks>
    ...
    public class AdvisorAdapterRegistrationManager : IObjectPostProcessor
    {
        ...
        /// <see cref="Oragon.Spring.Aop.Framework.Adapter.GlobalAdvisorAdapterRegistry"/>
        /// singleton if it is an <see cref="Oragon.Spring.Aop.Framework.Adapter.IAdvisorAdapter"/>
        /// instance.
        /// </p>
        /// </remarks>
        /// <param name="instance">
