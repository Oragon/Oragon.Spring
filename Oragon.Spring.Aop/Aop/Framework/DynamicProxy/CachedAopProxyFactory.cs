...
{
    /// <summary>
    /// Implementation of the <see cref="Oragon.Spring.Aop.Framework.IAopProxyFactory"/> 
    ...
    /// <seealso cref="Oragon.Spring.Aop.Framework.DynamicProxy.DefaultAopProxyFactory"/>
    /// <seealso cref="Oragon.Spring.Aop.Framework.IAopProxyFactory"/>
    [Serializable]
    public class CachedAopProxyFactory : DefaultAopProxyFactory
    {
        ...
        /// The <see cref="Oragon.Spring.Proxy.IProxyTypeBuilder"/> to use
        /// </param>
