...
{
    /// <summary>
    /// <see cref="Oragon.Spring.Proxy.IProxyMethodBuilder"/> implementation that delegates 
    /// method calls to an <see cref="Oragon.Spring.Aop.Framework.IAdvised"/> instance.
    /// </summary>
