...
using Oragon.Spring.Aop.Framework.Adapter;
...
{
    /// <summary>
    /// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> implementation to
    /// source AOP proxies from a Oragon.Spring.NET IoC container (an
    /// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>).
    /// </summary>
    /// <remarks>
    /// <p>
    /// <see cref="AopAlliance.Intercept.IInterceptor"/>s and
    /// <see cref="Oragon.Spring.Aop.IAdvisor"/>s are identified by a list of object
    ...
    /// <see cref="Oragon.Spring.Aop.Framework.ProxyFactoryObject"/> definition). The
    /// specified interceptors and advisors are expanded in an interceptor list
    /// (see
    /// <see cref="Oragon.Spring.Aop.Framework.ProxyFactoryObject.InterceptorNames"/>)
    ...
    /// <see cref="Oragon.Spring.Core.IOrdered"/> interface. An interceptor name list
    ...
    /// <see cref="Oragon.Spring.Aop.Framework.IAdvised"/> reference, or to obtain the
    /// <see cref="Oragon.Spring.Aop.Framework.ProxyFactoryObject"/> reference and
    ...
    /// <seealso cref="Oragon.Spring.Aop.Framework.ProxyFactoryObject.InterceptorNames"/>
    /// <seealso cref="Oragon.Spring.Aop.Framework.ProxyFactoryObject.ProxyInterfaces"/>
    /// <seealso cref="AopAlliance.Intercept.IMethodInterceptor"/>
    /// <seealso cref="Oragon.Spring.Aop.IAdvisor"/>
    /// <seealso cref="Oragon.Spring.Aop.Target.SingletonTargetSource"/>
    [Serializable]
        ...
        : AdvisedSupport, IFactoryObject, IObjectFactoryAware
    {
        ...
        /// <p>
        /// Only works when the
        /// <see cref="Oragon.Spring.Aop.Framework.ProxyFactoryObject.ObjectFactory"/>
        /// property is set; it is a logic error on the part of the programmer
        /// if this value is set and the accompanying
        /// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> is not also set.
        /// </p>
        /// </remarks>
        /// <value>
        ...
        /// <see cref="Oragon.Spring.Aop.IAdvisor"/> object names.
        /// </summary>
        /// <remarks>
        /// <p>
        /// This property must always be set (configured) when using a
        /// <see cref="Oragon.Spring.Aop.Framework.ProxyFactoryObject"/> in an
        /// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> context.
        /// </p>
        /// </remarks>
        /// <value>
        ...
        /// <seealso cref="Oragon.Spring.Aop.IAdvisor"/>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactoryAware.ObjectFactory"/>
        ...
        /// property is set; it is a logic error on the part of the programmer
        /// if this value is set and the accompanying
        /// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> is not supplied.
        /// </p>
        /// </remarks>
        /// <value>
        ...
        /// </summary>
        /// <value>
        /// Owning <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>
        ...
        /// call to <see cref="Oragon.Spring.Aop.Framework.ProxyFactoryObject.GetObject"/>
        /// for a prototype.
        /// </p>
        /// </remarks>
        /// <returns>
        ...
        /// </returns>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IFactoryObject.GetObject()"/>
        ...
        /// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> creates, or
