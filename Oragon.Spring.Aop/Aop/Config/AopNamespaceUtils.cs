...
using System;
using System.Xml;
using Oragon.Spring.Aop.Framework.AutoProxy;
...
namespace Oragon.Spring.Aop.Config
{
    /// <summary>
    ...
    public class AopNamespaceUtils
    {
        ...
        /// </summary>
        public static readonly string AUTO_PROXY_CREATOR_OBJECT_NAME = "Oragon.Spring.Aop.Config.InternalAutoProxyCreator";
