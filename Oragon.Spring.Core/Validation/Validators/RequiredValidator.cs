...
namespace Oragon.Spring.Validation
{
    ...
    public class RequiredValidator : BaseSimpleValidator
    {
        ...
        /// </summary>
        /// <remarks>
        /// In the case of the <see cref="Oragon.Spring.Validation.RequiredValidator"/> class,
        ...
        /// in the class overview of the <see cref="Oragon.Spring.Validation.RequiredValidator"/>
        /// class.
        /// </remarks>
