...
namespace Oragon.Spring.Validation.Config
{
    /// <summary>
    ...
    [
        NamespaceParser(
            ...
            SchemaLocation = "/Oragon.Spring.Validation.Config/spring-validation-1.3.xsd")
    ]
...
//            }
        ...
        private static IObjectDefinition ParseErrorMessageAction(XmlElement message, ParserContext parserContext)
        {
            ...
            string typeName = "Oragon.Spring.Validation.Actions.ErrorMessageAction, Oragon.Spring.Core";
        ...
        {
            string typeName = "Oragon.Spring.Validation.Actions.ExceptionAction, Oragon.Spring.Core";
        ...
        {
            string typeName = "Oragon.Spring.Validation.ValidatorReference, Oragon.Spring.Core";
