...
*/
namespace Oragon.Spring.Threading
{
	...
	public class TimeoutException : ThreadInterruptedException
	{
		...
		/// <see cref="Oragon.Spring.Threading.TimeoutException"/> class.
		/// </summary>
		public TimeoutException( ) : base(){}
		/// <summary>
		/// Creates a new instance of the
		/// <see cref="Oragon.Spring.Threading.TimeoutException"/> class with the
		/// specified message.
		/// </summary>
		/// <param name="message">
