...
namespace Oragon.Spring.Context.Support
{
	...
	/// <see cref="Oragon.Spring.Context.IMessageSourceResolvable"/> interface.
	/// </summary>
	/// <remarks>
	/// <p>
	/// Provides easy ways to store all the necessary values needed to resolve
	/// messages from an <see cref="Oragon.Spring.Context.IMessageSource"/>.
	/// </p>
	/// </remarks>
	...
	public class DefaultMessageSourceResolvable : IMessageSourceResolvable
	{
		...
		/// The <see cref="Oragon.Spring.Context.IMessageSourceResolvable"/> to be copied.
		/// </param>
	    ...
	    /// with this message.
	    /// </returns>
	    /// <seealso cref="Oragon.Spring.Context.IMessageSourceResolvable.GetCodes"/>
		...
		/// </returns>
		/// <seealso cref="Oragon.Spring.Context.IMessageSourceResolvable.GetArguments"/>
		...
		/// default.
		/// </returns>
		/// <seealso cref="Oragon.Spring.Context.IMessageSourceResolvable.DefaultMessage"/>
