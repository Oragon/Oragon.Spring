...
using Oragon.Spring.Context.Events;
using Oragon.Spring.Core;
using Oragon.Spring.Core.IO;
using Oragon.Spring.Objects;
using Oragon.Spring.Objects.Events;
using Oragon.Spring.Objects.Events.Support;
...
namespace Oragon.Spring.Context.Support
{
    ...
    /// <see cref="Oragon.Spring.Context.IApplicationContext"/> interface.
    /// </summary>
    /// <remarks>
    /// <p>
    ...
    /// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>, an
    /// <see cref="Oragon.Spring.Context.IApplicationContext"/> is supposed
    /// to detect special objects defined in its object factory: therefore,
    /// this class automatically registers
    /// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectFactoryPostProcessor"/>s,
    /// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectPostProcessor"/>s
    /// and <see cref="Oragon.Spring.Context.IApplicationEventListener"/>s that are
    /// defined as objects in the context.
    /// </p>
    /// <p>
    /// An <see cref="Oragon.Spring.Context.IMessageSource"/> may be also supplied as
    ...
    /// <seealso cref="Oragon.Spring.Objects.Factory.Config.IObjectPostProcessor"/>
    /// <seealso cref="Oragon.Spring.Objects.Factory.Config.IObjectFactoryPostProcessor"/>
        ...
        : ConfigurableResourceLoader, IConfigurableApplicationContext, IObjectDefinitionRegistry
    {
        ...
        /// <summary>
        /// Name of the .Net config section that contains Oragon.Spring.Net context definition.
        /// </summary>
        ...
        /// <see cref="Oragon.Spring.Context.IMessageSource"/> in the context.
        /// </summary>
        /// <remarks>
        /// <p>
        /// If no <see cref="Oragon.Spring.Context.IMessageSource"/> can be found
        ...
        /// <summary>
        /// The special, well-known-name of the default
        /// <see cref="Oragon.Spring.Objects.Events.IEventRegistry"/> in the context.
        /// </summary>
        /// <remarks>
        /// <p>
        /// If no <see cref="Oragon.Spring.Objects.Events.IEventRegistry"/> can be found
        /// in the context using this lookup key, then a default
        /// <see cref="Oragon.Spring.Objects.Events.IEventRegistry"/> will be used.
        /// </p>
        /// </remarks>
        ...
        /// <summary>
        /// The <see cref="Oragon.Spring.Context.IMessageSource"/> instance we delegate
        /// our implementation of said interface to.
        /// </summary>
        private IMessageSource _messageSource;

        /// <summary>
        /// The <see cref="Oragon.Spring.Objects.Events.IEventRegistry"/> instance we
        ...
        /// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>).
        /// </summary>
        ...
        /// <see cref="Oragon.Spring.Context.Support.AbstractApplicationContext.Refresh()"/>,
        ...
        /// <summary>
        /// The <see cref="Oragon.Spring.Context.IMessageSource"/> for this context.
        /// </summary>
        ...
        /// <summary>
        /// The <see cref="Oragon.Spring.Objects.Events.IEventRegistry"/> for this context.
        /// </summary>
        /// <exception cref="System.InvalidOperationException">
        /// If the context has not been initialized yet.
        /// </exception>
        ...
        /// <see cref="Oragon.Spring.Context.IConfigurableApplicationContext"/>; else,
        ...
        /// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectPostProcessor"/>s
        /// in certain
        /// <see cref="Oragon.Spring.Context.IApplicationContext"/> implementations.
        /// </p>
        /// </remarks>
        ...
        /// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectFactoryPostProcessor"/>
        ...
        /// <summary>
        /// Add a new <see cref="Oragon.Spring.Objects.Factory.Config.IObjectFactoryPostProcessor"/>
        ...
        /// </summary>
        /// <exception cref="Oragon.Spring.Context.ApplicationContextException">
        ...
        /// parent.
        /// </returns>
        /// <seealso cref="Oragon.Spring.Context.IApplicationContext.ParentContext"/>
        ...
        /// <returns>
        /// The registered
        /// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectDefinition"/>.
        /// </returns>
        ...
        /// </value>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IListableObjectFactory.ObjectDefinitionCount"/>
        ...
        /// </returns>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IListableObjectFactory.ContainsObjectDefinition(string)"/>
        ...
        /// If the object could not be created.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory.GetObject(string)"/>
        ...
        /// </returns>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory.ContainsObject(string)"/>
        ...
        /// If there's no such object definition.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory.GetAliases(string)"/>
        ...
        /// If the object could not be created.
        /// </exception>
        /// <exception cref="Oragon.Spring.Objects.Factory.ObjectNotOfRequiredTypeException">
        ...
        /// If the supplied <paramref name="name"/> is <see langword="null"/>.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory.GetObject(string, Type, object[])"/>
        /// <remarks>
        ///  This method will only <b>instantiate</b> the requested object. It does <b>NOT</b> inject any dependencies!
        /// </remarks>
        ...
        /// If the object is not of the required type.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory.GetObject(string, Type)"/>
        ...
        /// If there's no such object definition.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory.IsSingleton(string)"/>
        ...
        /// if not determinable.
        /// </returns>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory.GetType(string)"/>
        ...
        /// </param>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IObjectFactory.ConfigureObject(object, string)"/>
        ...
        /// </value>
        /// <seealso cref="Oragon.Spring.Objects.Factory.IHierarchicalObjectFactory.ParentObjectFactory"/>
        ...
        /// Must support
        /// <see cref="Oragon.Spring.Objects.Factory.Support.RootObjectDefinition"/>
        /// and <see cref="Oragon.Spring.Objects.Factory.Support.ChildObjectDefinition"/>.
        /// </summary>
        ...
        /// 	<p>
        /// Must support
        /// <see cref="Oragon.Spring.Objects.Factory.Support.RootObjectDefinition"/> and
        ...
        /// </returns>
        /// <exception cref="Oragon.Spring.Context.NoSuchMessageException">
        /// If no message could be resolved.
        /// </exception>
        /// <exception cref="System.ArgumentNullException">
        /// If the supplied <paramref name="name"/> is <see langword="null"/>.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Context.IMessageSource.GetMessage(string, CultureInfo, object[])"/>
        ...
        /// If no message could be resolved.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Context.IMessageSource.GetMessage(string)"/>
        ...
        /// If the supplied <paramref name="name"/> is <see langword="null"/>.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Context.IMessageSource.GetMessage(string, object[])"/>
        ...
        /// If the supplied <paramref name="name"/> is <see langword="null"/>.
        /// </exception>
        /// <seealso cref="Oragon.Spring.Context.IMessageSource.GetMessage(string, CultureInfo)"/>
        ...
        /// the supplied <see cref="Oragon.Spring.Context.IMessageSourceResolvable"/>
        /// argument.
        /// </summary>
        ...
        /// </exception>
        /// <seealso cref="Oragon.Spring.Context.IMessageSource.GetMessage(IMessageSourceResolvable, CultureInfo)"/>
        ...
        /// The resolved object, or <see langword="null"/> if not found.
        /// </returns>
        /// <seealso cref="Oragon.Spring.Context.IMessageSource.GetResourceObject(string, CultureInfo)"/>
        ...
        /// The resolved object, or <see langword="null"/> if not found.
        /// </returns>
        /// <seealso cref="Oragon.Spring.Context.IMessageSource.GetResourceObject(string)"/>
        ...
        /// resource is associated.
        /// </param>
        /// <seealso cref="Oragon.Spring.Context.IMessageSource.ApplyResources(object, string, CultureInfo)"/>
        ...
        /// </param>
        /// <seealso cref="Oragon.Spring.Objects.Events.IEventRegistry.PublishEvents"/>
        ...
        /// <seealso cref="Oragon.Spring.Objects.Events.IEventRegistry.Subscribe(object)"/>
        ...
        /// </param>
        /// <seealso cref="Oragon.Spring.Objects.Events.IEventRegistry.Subscribe(object, Type)"/>
        ...
        /// </param>
        /// <seealso cref="Oragon.Spring.Context.IApplicationEventPublisher.PublishEvent"/>
