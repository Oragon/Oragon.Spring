...
{
    /// <summary>
    /// Empty <see cref="Oragon.Spring.Context.IMessageSource"/> implementation that
    /// simply delegates all method calls to it's parent
    /// <see cref="Oragon.Spring.Context.IMessageSource"/>.
    /// </summary>
    /// <remarks>
    /// <p>
    /// If no parent <see cref="Oragon.Spring.Context.IMessageSource"/> is available,
    /// no messages will be resolved (and a
    /// <see cref="Oragon.Spring.Context.NoSuchMessageException"/> will be thrown).
    /// </p>
    /// <p>
    /// Used as placeholder <see cref="Oragon.Spring.Context.IMessageSource"/> by the
    /// <see cref="Oragon.Spring.Context.Support.AbstractApplicationContext"/> class,
    /// if the context definition doesn't define its own
    /// <see cref="Oragon.Spring.Context.IMessageSource"/>. Not intended for direct use
    /// in applications.
    /// </p>
    /// </remarks>
    /// <author>Juergan Hoeller</author>
    /// <author>Rick Evans (.NET)</author>
    /// <seealso cref="Oragon.Spring.Context.Support.AbstractApplicationContext"/>
    public class DelegatingMessageSource : IHierarchicalMessageSource
    {
        ...
        /// <see cref="Oragon.Spring.Context.Support.DelegatingMessageSource"/> class.
        /// </summary>
        ...
        /// this object can't resolve.
        /// </summary>
        /// <seealso cref="Oragon.Spring.Context.IHierarchicalMessageSource.ParentMessageSource"/>
