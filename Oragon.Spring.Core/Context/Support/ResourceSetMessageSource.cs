...
{
	/// <summary>
	/// An <see cref="Oragon.Spring.Context.IMessageSource"/> implementation that
	...
	public class ResourceSetMessageSource : AbstractMessageSource, IInitializingObject
	{
		...
		/// <see cref="Oragon.Spring.Context.Support.ResourceSetMessageSource"/> class.
		/// </summary>
		...
		/// in this <see cref="Oragon.Spring.Context.Support.ResourceSetMessageSource"/>.
		/// </summary>
	    ...
	    /// <see cref="Oragon.Spring.Context.Support.ResourceSetMessageSource"/>.
	    /// </summary>
	    /// <returns>A <see cref="System.String"/> representation of the
	    /// <see cref="Oragon.Spring.Context.Support.ResourceSetMessageSource"/>.</returns>
