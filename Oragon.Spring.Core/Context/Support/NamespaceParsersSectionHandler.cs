...
{
	/// <summary>
	/// Configuration section handler for the (recommended, Oragon.Spring.NET standard) <c>parsers</c>
	/// config section.
	/// </summary>
	/// <remarks>
	/// <p>
	/// Oragon.Spring.NET allows the registration of custom configuration parsers that
	/// can be used to create simplified configuration schemas that better
	/// describe object definitions.
	/// </p>
	/// <p>
	/// For example, Oragon.Spring.NET uses this facility internally in order to
	...
	/// and how to define custom configuration parsers within a Oragon.Spring.NET
	/// config section.
	/// </p>
	/// <code escaped="true">
	/// <configuration>
    ...
    ///			    <section name="parsers" type="Oragon.Spring.Context.Support.NamespaceParsersSectionHandler, Oragon.Spring.Core"/>
	///		    </sectionGroup>
	///     </configSections>
	///     <spring>
	///		    <parsers>
    ///			    <parser type="Oragon.Spring.Aop.Config.AopNamespaceParser, Oragon.Spring.Aop"/>
    ///			    <parser type="Oragon.Spring.Data.Config.DatabaseNamespaceParser, Oragon.Spring.Data"/>
	///			    ...
	///		    </parsers>
	///		    ...
	///     </spring>
    ...
    public class NamespaceParsersSectionHandler : IConfigurationSectionHandler
	{
		...
		/// <summary>
		/// Registers parsers specified in the (recommended, Oragon.Spring.NET standard)
