...
namespace Oragon.Spring.Context.Support
{
	...
	public abstract class ApplicationObjectSupport : IApplicationContextAware
	{
		...
		/// <see cref="Oragon.Spring.Context.Support.ApplicationObjectSupport"/> class.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <see cref="Oragon.Spring.Context.Support.ApplicationObjectSupport.ApplicationContext"/>
		/// must be an instance of.
		/// </summary>
		/// <value>
		/// The <see cref="Oragon.Spring.Context.IApplicationContext"/>
		...
		/// <summary>
		/// Return a <see cref="Oragon.Spring.Context.Support.MessageSourceAccessor"/> for the
		...
		/// <summary>
		/// Gets or sets the <see cref="Oragon.Spring.Context.IApplicationContext"/> that this
		/// object runs in.
		/// </summary>
		...
		/// <see cref="Oragon.Spring.Context.Support.ApplicationObjectSupport.RequiredType"/>. 
		/// property. Also, thrown when trying to re-initialize with a
		/// different <see cref="Oragon.Spring.Context.IApplicationContext"/> than was
		/// originally used.
		/// </exception>
		...
		/// <seealso cref="Oragon.Spring.Context.IApplicationContextAware.ApplicationContext"/>
