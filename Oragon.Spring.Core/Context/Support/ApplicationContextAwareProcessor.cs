...
{
    /// <summary>
    /// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectPostProcessor"/>
    /// implementation that passes the application context to object that
    /// implement the
    /// <see cref="Oragon.Spring.Context.IApplicationContextAware"/>,
    /// <see cref="Oragon.Spring.Context.IMessageSourceAware"/>, and
    /// <see cref="Oragon.Spring.Context.IResourceLoaderAware"/> interfaces. 
    /// </summary>
    /// <remarks>
    /// <p>
    ...
    /// <see cref="Oragon.Spring.Context.IApplicationContextAware"/>,
    /// <see cref="Oragon.Spring.Context.IMessageSourceAware"/>, and
    /// <see cref="Oragon.Spring.Context.IResourceLoaderAware"/> interfaces, then the
    ...
    /// </description></item>
    /// <item><description>
    /// <see cref="Oragon.Spring.Context.IMessageSourceAware"/>
    /// </description></item>
    /// <item><description>
    /// <see cref="Oragon.Spring.Context.IApplicationContextAware"/>
    /// </description></item>
    ...
    public class ApplicationContextAwareProcessor : IObjectPostProcessor
	{
		...
		/// <see cref="Oragon.Spring.Context.Support.ApplicationContextAwareProcessor"/> class.
		/// </summary>
		/// <param name="applicationContext">
		/// The <see cref="Oragon.Spring.Context.IApplicationContext"/> that this
		...
		/// <summary>
		/// Apply this <see cref="Oragon.Spring.Objects.Factory.Config.IObjectPostProcessor"/>
		...
		/// <summary>
		/// Apply this <see cref="Oragon.Spring.Objects.Factory.Config.IObjectPostProcessor"/> to the
