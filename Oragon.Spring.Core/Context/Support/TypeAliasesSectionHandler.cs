...
{
    /// <summary>
    /// Configuration section handler for the Oragon.Spring.NET <c>typeAliases</c>
    /// config section.
    /// </summary>
    /// <remarks>
    /// <p>
    /// Type aliases can be used instead of fully qualified type names anywhere
    /// a type name is expected in a Oragon.Spring.NET configuration file.
    /// </p>
    /// <p>
    ...
    /// how to define type aliases within a Oragon.Spring.NET config section:
    /// </p>
    /// <code escaped="true">
    /// <configuration>
    ///     <configSections>
    ///		    <sectionGroup name="spring">
    ///			    <section name="typeAliases" type="Oragon.Spring.Context.Support.TypeAliasesSectionHandler, Oragon.Spring.Core"/>
    ///		    </sectionGroup>
    ///     </configSections>
    ///     <spring>
    ///		    <typeAliases>
    ///			    <alias name="WebServiceExporter" type="Oragon.Spring.Web.Services.WebServiceExporter, Oragon.Spring.Web"/>
