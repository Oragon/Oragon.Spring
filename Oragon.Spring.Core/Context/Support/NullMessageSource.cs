...
{
    /// <summary>
    /// An <see cref="Oragon.Spring.Context.IMessageSource"/> that doesn't do a whole lot.
    /// </summary>
    /// <remarks>
    /// <p>
    /// <see cref="Oragon.Spring.Context.Support.NullMessageSource"/> is an implementation of
    /// the <c>NullObject</c> pattern. It should be used in those situations where a
    /// <see cref="Oragon.Spring.Context.IMessageSource"/> needs to be passed (say to a
    ...
    /// <see cref="Oragon.Spring.Context.Support.NullMessageSource"/> does not maintan any state
    /// and the <see cref="Oragon.Spring.Context.Support.NullMessageSource.Null"/> instance is
    ...
    public sealed class NullMessageSource : AbstractMessageSource
    {
        ...
        /// <see cref="Oragon.Spring.Context.Support.NullMessageSource"/> class.
        /// </summary>
        ...
        /// <remarks>
        /// <p>
        /// Consider using <see cref="Oragon.Spring.Context.Support.NullMessageSource.Null"/>
        /// instead.
        /// </p>
        /// </remarks>
