...
{
    /// <summary>
    /// Abstract implementation of the <see cref="Oragon.Spring.Context.IHierarchicalMessageSource"/> interface,
    /// implementing common handling of message variants, making it easy
    /// to implement a specific strategy for a concrete <see cref="Oragon.Spring.Context.IMessageSource"/>.
    /// </summary>
    /// <remarks>
    ...
    /// <seealso cref="Oragon.Spring.Context.IMessageSourceResolvable"/>
    /// <seealso cref="Oragon.Spring.Context.IMessageSource"/>
    /// <seealso cref="Oragon.Spring.Context.IHierarchicalMessageSource"/>
