...
{
    /// <summary>
    /// Configuration section handler for the Oragon.Spring.NET <c>typeConverters</c>
    /// config section.
    /// </summary>
    /// <remarks>
    /// <p>
    ...
    /// </p>
    /// <p>
    /// They are a very powerful mechanism as they allow Oragon.Spring.NET to automatically
    ...
    /// via a web form into a type that is used by your data model when Oragon.Spring.NET data
    ...
    /// how to define type converters within a Oragon.Spring.NET config section:
    /// </p>
    /// <code escaped="true">
    /// <configuration>
    ///     <configSections>
    ///		    <sectionGroup name="spring">
    ///			    <section name="typeConverters" type="Oragon.Spring.Context.Support.TypeConvertersSectionHandler, Oragon.Spring.Core"/>
    ///		    </sectionGroup>
    ///     </configSections>
    ///     <spring>
    ///		    <typeConverters>
    ///			    <converter for="Oragon.Spring.Expressions.IExpression, Oragon.Spring.Core" type="Oragon.Spring.Expressions.ExpressionConverter, Oragon.Spring.Core"/>
    ...
    /// <seealso cref="Oragon.Spring.Core.TypeResolution.TypeRegistry"/>
