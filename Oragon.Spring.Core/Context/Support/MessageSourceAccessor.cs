...
namespace Oragon.Spring.Context.Support
{
	...
	/// <see cref="Oragon.Spring.Context.IMessageSource"/>, providing various
	/// overloaded <c>GetMessage</c> methods.
	/// </summary>
	/// <remarks>
	/// <p>
	/// Available from
	/// <see cref="Oragon.Spring.Context.Support.ApplicationObjectSupport"/>, but also
	...
	/// <seealso cref="Oragon.Spring.Context.Support.ApplicationObjectSupport"/>
	public class MessageSourceAccessor
	{
		...
		/// <see cref="Oragon.Spring.Context.Support.MessageSourceAccessor"/> class
		...
		/// The <see cref="Oragon.Spring.Context.IMessageSource"/> to use to locate messages.
		/// </param>
		...
		/// </summary>
		/// <param name="messageSource">
		/// The <see cref="Oragon.Spring.Context.IMessageSource"/> to use to locate
		/// messages.
		/// </param>
		...
		/// <see cref="Oragon.Spring.Context.IMessageSourceResolvable"/>.
		/// </summary>
		/// <param name="resolvable">
		/// The <see cref="Oragon.Spring.Context.IMessageSourceResolvable"/>.
		/// </param>
		/// <returns>The message.</returns>
		/// <exception cref="NoSuchMessageException">
		/// If the message could not be found.
		...
		/// <summary>
		/// Retrieve a mesage using the given
		/// <see cref="Oragon.Spring.Context.IMessageSourceResolvable"/> in the given
		/// <see cref="System.Globalization.CultureInfo"/>.
		/// </summary>
		/// <param name="resolvable">
		/// The <see cref="Oragon.Spring.Context.IMessageSourceResolvable"/>.
