...
{
    /// <summary>
    /// An <see cref="Oragon.Spring.Context.IApplicationContext"/> implementation that
    ...
    /// <see cref="Oragon.Spring.Core.IO.IResource"/> interface and and register them
    /// with any <see cref="Oragon.Spring.Context.IApplicationContext"/> that inherits
    /// from the
    /// <see cref="Oragon.Spring.Context.Support.AbstractApplicationContext"/>
    /// interface.
    /// </p>
    /// <note>
    ...
    /// <see cref="Oragon.Spring.Context.Support.XmlApplicationContext"/> using a
    ...
    public class XmlApplicationContext : AbstractXmlApplicationContext
    {
        ...
        /// <see cref="Oragon.Spring.Context.Support.XmlApplicationContext"/> class,
