...
{
	/// <summary>
	/// Creates an <see cref="Oragon.Spring.Context.IApplicationContext"/> instance
	...
	/// </summary>
	/// <remarks>
	/// Implementations of the <see cref="Oragon.Spring.Context.IApplicationContext"/>
	...
	/// <see cref="Oragon.Spring.Context.IApplicationContext"/> <see cref="System.Type"/>
	/// is assumed. This default
	/// <see cref="Oragon.Spring.Context.IApplicationContext"/> <see cref="System.Type"/>
	/// is currently the <see cref="Oragon.Spring.Context.Support.XmlApplicationContext"/>
	/// <see cref="System.Type"/>; please note the exact <see cref="System.Type"/>
	/// of this default <see cref="Oragon.Spring.Context.IApplicationContext"/> is an
	...
	/// an embedded Oragon.Spring.NET XML object configuration file...
	/// </p>
	/// <code escaped="true">
	/// <configuration>
	///     <configSections>
	///		    <sectionGroup name="spring">
	///			    <section name="context" type="Oragon.Spring.Context.Support.ContextHandler, Oragon.Spring.Core"/>
	///		    </sectionGroup>
	///     </configSections>
	///     <spring>
	///		    <context>
	...
	///		    <sectionGroup name="spring">
	///			    <section name="context"
	///				    type="Oragon.Spring.Context.Support.ContextHandler, Oragon.Spring.Core"/>
	///			    <section name="objects"
	///				    type="Oragon.Spring.Context.Support.DefaultSectionHandler, Oragon.Spring.Core" />
	///		    </sectionGroup>
	///     </configSections>
	///     <spring>
	///		    <context
	///		        caseSensitive="false"
	///			    type="Oragon.Spring.Context.Support.XmlApplicationContext, Oragon.Spring.Core">
    ...
    ///         <child>
    /// 		    <objects xmlns='http://www.springframework.net'>
	/// 			    <object id='Child' type='Oragon.Spring.Objects.TestObject,Oragon.Spring.Core.Tests'>
	...
	public class ContextHandler : IConfigurationSectionHandler
	{
		...
		/// <summary>
		/// The <see cref="System.Type"/> of <see cref="Oragon.Spring.Context.IApplicationContext"/>
	    ...
	    /// <remarks>
	    /// <p>
	    /// This <see cref="Oragon.Spring.Context.IApplicationContext"/> instance is
	    ...
	    /// </param>
	    /// <returns>
	    /// An <see cref="Oragon.Spring.Context.IApplicationContext"/> instance
	    ...
	    /// <see cref="Oragon.Spring.Context.Support.XmlApplicationContext"/> type.
	    /// </p>
	    /// </remarks>
	    ...
	    /// schema for laying out Oragon.Spring.NET contexts in XML.
	    /// </summary>
	    private sealed class ContextSchema
	    {
	        /// <summary>
	        /// Defines a single
	        /// <see cref="Oragon.Spring.Context.IApplicationContext"/>.
	        /// </summary>
	        ...
	        /// <summary>
	        /// Defines an <see cref="Oragon.Spring.Core.IO.IResource"/>
	        /// </summary>
	        public const string ResourceElement = "resource";

	        /// <summary>
	        /// Specifies the URI for an
	        /// <see cref="Oragon.Spring.Core.IO.IResource"/>.
	        /// </summary>
