...
{
    /// <summary>
    /// Simple implementation of <see cref="Oragon.Spring.Context.IMessageSource"/>
	...
	/// </p>
	/// <p>
	/// This <see cref="Oragon.Spring.Context.IMessageSource"/> supports internationalization.
	/// </p>
	/// </remarks>
    ...
    public class StaticMessageSource : AbstractMessageSource
    {
		...
		/// <see cref="Oragon.Spring.Context.Support.StaticMessageSource"/> class.
		/// </summary>
		...
		/// </returns>
		/// <seealso cref="Oragon.Spring.Context.Support.AbstractMessageSource.ResolveMessage(string, CultureInfo)"/>
		...
		/// </returns>
		/// <seealso cref="Oragon.Spring.Context.Support.AbstractMessageSource.ResolveObject(string, CultureInfo)"/>
	...
	//
		...
		/// This feature is not currently supported on version 1.0 of the .NET platform.
		/// </exception>
		/// <seealso cref="Oragon.Spring.Context.Support.AbstractMessageSource.ApplyResourcesToObject(object, string, CultureInfo)"/>
