...
using Oragon.Spring.Objects.Factory.Parsing;
using Oragon.Spring.Objects.Factory.Support;
using Oragon.Spring.Stereotype;
...
{
    /// <summary>
    /// Reads the class with the <see cref="ConfigurationAttribute"/> applied and converts it into an <see cref="Oragon.Spring.Objects.Factory.Config.IObjectDefinition"/> instance.
    /// </summary>
