...
using Oragon.Spring.Context.Attributes;
using Oragon.Spring.Context.Attributes.TypeFilters;
...
namespace Oragon.Spring.Context.Config
{
    /// <summary>
	...
	public class ComponentScanObjectDefinitionParser : IObjectDefinitionParser
    {
        ...
        /// ObjectDefinitions with the <see cref="P:Oragon.Spring.Objects.Factory.Xml.ParserContext.Registry"/> IObjectDefinitionRegistry
        /// embedded in the supplied <see cref="T:Oragon.Spring.Objects.Factory.Xml.ParserContext"/>
        /// </summary>
