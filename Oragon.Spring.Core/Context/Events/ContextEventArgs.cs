...
namespace Oragon.Spring.Context.Events
{
	/// <summary>
	/// Event object sent to listeners registered with an
	/// <see cref="Oragon.Spring.Context.IApplicationContext"/> to inform them of
	/// context lifecycle events.
	/// </summary>
	/// <author>Griffin Caprio (.NET)</author>
	/// <seealso cref="Oragon.Spring.Context.IApplicationContext"/>
	/// <seealso cref="Oragon.Spring.Context.IApplicationEventListener"/>
	/// <seealso cref="Oragon.Spring.Context.EventListenerAttribute"/>
