...
{
	/// <summary>
	/// The central interface to Oragon.Spring.NET's IoC container.
	/// </summary>
	/// <remarks>
	/// <p>
	...
	/// and <see cref="Oragon.Spring.Objects.Factory.IHierarchicalObjectFactory"/>
	/// interfaces.
	/// </description>
	/// </item>
	/// <item>
	...
	/// Inherited from the <see cref="Oragon.Spring.Context.IMessageSource"/>
	/// interface.
	/// </description>
	/// </item>
	/// <item>
	...
	/// Inherited from the <see cref="Oragon.Spring.Core.IO.IResourceLoader"/>
	/// interface.
	/// </description>
	/// </item>
	/// <item>
	...
	/// <see cref="Oragon.Spring.Objects.Events.IEventRegistry"/> interface.
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	/// The ability to raise events related to the context lifecycle. Inherited
	/// from the <see cref="Oragon.Spring.Context.IApplicationEventPublisher"/>
	/// interface.
	/// </description>
	/// </item>
	/// <item>
	...
	/// <see cref="Oragon.Spring.Context.IApplicationContext"/> implementations need
	/// to detect
	/// <see cref="Oragon.Spring.Context.IApplicationContextAware"/>,
	/// <see cref="Oragon.Spring.Objects.Events.IEventRegistryAware"/>, and
	/// <see cref="Oragon.Spring.Context.IMessageSourceAware"/> objects and supply
	/// their attendant dependencies accordingly.
	/// </p>
	/// <p>
	/// This interface is the central client interface in Oragon.Spring.NET's IoC
	...
	/// <seealso cref="Oragon.Spring.Context.Support.XmlApplicationContext"/>
	/// <seealso cref="Oragon.Spring.Context.Support.DelegatingMessageSource"/>
	/// <seealso cref="Oragon.Spring.Objects.Factory.Support.DefaultListableObjectFactory"/>
			...
			IApplicationEventPublisher, IResourceLoader, IEventRegistry, IDisposable
	{
		...
		/// <see cref="Oragon.Spring.Context.IApplicationContext"/> has been
		...
		/// was loaded.
		/// </returns>
		/// <seealso cref="Oragon.Spring.Context.IConfigurableApplicationContext.Refresh"/>
