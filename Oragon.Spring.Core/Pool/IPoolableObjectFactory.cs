...
namespace Oragon.Spring.Pool
{
	/// <summary>
	/// Defines lifecycle methods for objects that are to be used in an
	/// <see cref="Oragon.Spring.Pool.IObjectPool"/> implementation.
	/// </summary>
	/// <remarks>
	/// <p>
	/// The following methods summarize the contract between an
	/// <see cref="Oragon.Spring.Pool.IObjectPool"/> and an
	/// an <see cref="Oragon.Spring.Pool.IPoolableObjectFactory"/>.
	/// </p>
	/// <list type="number">
	///   <item>
	///		<see cref="Oragon.Spring.Pool.IPoolableObjectFactory.MakeObject"/>
	///		is called whenever a new instance is needed.
	///   </item>
	///   <item>
	///		<see cref="Oragon.Spring.Pool.IPoolableObjectFactory.ActivateObject"/>
	///		is invoked on every instance before it is returned from
	///		the pool.
	///   </item>
	///   <item>
	///		<see cref="Oragon.Spring.Pool.IPoolableObjectFactory.PassivateObject"/>
	///		is invoked on every instance when it is returned to the pool.
	///   </item>
	///   <item>
	///		<see cref="Oragon.Spring.Pool.IPoolableObjectFactory.DestroyObject"/>
	///		is invoked on every instance when it is being dropped from the
	///		pool (see
	///		<see cref="Oragon.Spring.Pool.IPoolableObjectFactory.ValidateObject"/>
	///   </item>
	/// </list>
	/// <p>
	...
	/// <seealso cref="Oragon.Spring.Pool.IObjectPool"/>
