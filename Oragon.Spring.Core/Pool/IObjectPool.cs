...
namespace Oragon.Spring.Pool
{
	...
	/// <seealso cref="Oragon.Spring.Pool.IPoolableObjectFactory"/>
	public interface IObjectPool
	{
		...
		/// instance using <see cref="Oragon.Spring.Pool.IObjectPool.ReturnObject"/>
		...
		/// <see cref="Oragon.Spring.Pool.IObjectPool.BorrowObject"/>
