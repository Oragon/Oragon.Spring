...
namespace Oragon.Spring.Pool.Support
{
	/// <summary>
	...
	public class SimplePool : IObjectPool
	{
		...
		/// <summary>
		/// Creates a new instance of the <see cref="Oragon.Spring.Pool.Support.SimplePool"/>
		/// class.
		/// </summary>
		/// <param name="factory">
		...
		/// </summary>
		/// <exception cref="Oragon.Spring.Pool.PoolException">
		/// In case the pool is unusable.
		/// </exception>
		/// <seealso cref="Oragon.Spring.Pool.IPoolableObjectFactory.ActivateObject"/>
		/// <seealso cref="Oragon.Spring.Pool.IObjectPool.BorrowObject"/>
		...
		/// <seealso cref="Oragon.Spring.Pool.IPoolableObjectFactory.PassivateObject"/>
		/// <seealso cref="Oragon.Spring.Pool.IObjectPool.ReturnObject"/>
		...
		/// </summary>
		/// <seealso cref="Oragon.Spring.Pool.Support.SimplePool.BorrowObject"/>
		...
		/// If the implementation does not support the operation.
		/// </exception>
		/// <seealso cref="Oragon.Spring.Pool.IObjectPool.NumActive"/>
		...
		/// If the implementation does not support the operation.
		/// </exception>
		/// <seealso cref="Oragon.Spring.Pool.IObjectPool.NumIdle"/>
		public int NumIdle
		{
