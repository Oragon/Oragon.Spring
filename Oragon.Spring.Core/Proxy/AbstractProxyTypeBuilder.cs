...
namespace Oragon.Spring.Proxy
{
	...
	public abstract class AbstractProxyTypeBuilder : IProxyTypeBuilder, IProxyTypeGenerator
	{
        ...
        /// (See 'Oragon.Spring.Aop.Framework.DynamicProxy.IAdvisedProxyMethodBuilder' 
        ...
        /// (See 'Oragon.Spring.Web.Services.WebServiceProxyFactory' implementation for another example)
        /// </li>
        /// </ul>
        /// </p>
        /// </remarks>
