...
namespace Oragon.Spring.Core.IO
{
    /// <summary>
    /// Convenience base class for <see cref="Oragon.Spring.Core.IO.IResource"/>
    /// implementations, pre-implementing typical behavior.
    /// </summary>
    /// <remarks>
    /// <p>
    /// The <see cref="Oragon.Spring.Core.IO.AbstractResource.Exists"/> method will
    /// check whether a <see cref="System.IO.FileInfo"/> or
    /// <see cref="System.IO.Stream"/> can be opened;
    /// <see cref="Oragon.Spring.Core.IO.AbstractResource.IsOpen"/> will always return
    /// <see langword="false"/>;
    /// <see cref="Oragon.Spring.Core.IO.AbstractResource.Uri"/> and
    /// <see cref="Oragon.Spring.Core.IO.AbstractResource.File"/> throw an exception;
    /// and <see cref="Oragon.Spring.Core.IO.AbstractResource.ToString()"/> will
    /// return the value of the
    /// <see cref="Oragon.Spring.Core.IO.IResource.Description"/> property.
    /// </p>
    /// </remarks>
    /// <author>Juergen Hoeller</author>
    /// <author>Rick Evans (.NET)</author>
    /// <author>Aleksandar Seovic (.NET)</author>
    /// <seealso cref="Oragon.Spring.Core.IO.IResource"/>
    public abstract class AbstractResource : IResource
    {
        ...
        /// <remarks>
        /// <p>
        /// Will be resolved (by those <see cref="Oragon.Spring.Core.IO.IResource"/>
        /// implementations that support it) to the home (or root) path for
        /// the specific <see cref="Oragon.Spring.Core.IO.IResource"/> implementation.
        /// </p>
        /// <p>
        ...
        /// </p>
        /// </remarks>
        /// <seealso cref="Oragon.Spring.Core.IO.AbstractResource.DefaultBasePathPlaceHolder"/>
        ...
        /// </exception>
        /// <seealso cref="Oragon.Spring.Core.IO.IInputStreamSource.InputStream"/>
        ...
        /// </value>
        /// <seealso cref="Oragon.Spring.Core.IO.IResource.Description"/>
        ...
        /// open stream.
        /// </value>
        /// <seealso cref="Oragon.Spring.Core.IO.IResource.IsOpen"/>
        ...
        /// </summary>
        /// <seealso cref="Oragon.Spring.Core.IO.IResource.Uri"/>
        ...
        /// </exception>
        /// <seealso cref="Oragon.Spring.Core.IO.IResource"/>
        /// <see cref="Oragon.Spring.Core.IO.IResource.Exists"/>
        ...
        /// </value>
        /// <seealso cref="Oragon.Spring.Core.IO.IResource.Exists"/>
        /// <seealso cref="Oragon.Spring.Core.IO.IResource.File"/>
        ...
        /// The name of the resource without the protocol name.
        /// </returns>
        /// <see cref="Oragon.Spring.Core.IO.AbstractResource.GetResourceNameWithoutProtocol"/>
        ...
        /// <summary>
        /// Does this <see cref="Oragon.Spring.Core.IO.IResource"/> support relative
        /// resource retrieval?
        /// </summary>
        /// <remarks>
        /// <p>
        ...
        /// <see cref="Oragon.Spring.Core.IO.IResource.CreateRelative"/>).
        /// </p>
        /// <p>
        /// This, the default implementation, always returns
        /// <see langword="false"/>.
        ...
        /// <see cref="Oragon.Spring.Core.IO.IResource"/> supports relative resource
        /// retrieval.
        /// </value>
