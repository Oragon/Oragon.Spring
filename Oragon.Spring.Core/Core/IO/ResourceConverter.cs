...
{
	/// <summary>
	/// Custom type converter for <see cref="Oragon.Spring.Core.IO.IResource"/> instances.
	/// </summary>
	/// <remarks>
	/// <p>
	...
	public class ResourceConverter : TypeConverter
	{
		...
		/// <summary>
		/// Creates a new instance of the
		/// <see cref="Oragon.Spring.Core.IO.ResourceConverter"/> class using the specified resourceLoader.
		/// </summary>
		...
		/// <see cref="System.Type"/> to a <see cref="Oragon.Spring.Core.IO.IResource"/>
		/// </summary>
		/// <param name="context">
		...
		/// <see cref="Oragon.Spring.Core.IO.IResource"/> instance.
		/// </summary>
		/// <param name="context">
		/// A <see cref="System.ComponentModel.ITypeDescriptorContext"/>
		/// that provides a format context.
		...
		/// </param>
		/// <returns>
		/// An <see cref="Oragon.Spring.Core.IO.IResource"/> if successful. 
		/// </returns>
		...
		/// <summary>
		/// Return the <see cref="Oragon.Spring.Core.IO.IResourceLoader"/> used to
		/// resolve the string.
		/// </summary>
		/// <returns>
		/// The <see cref="Oragon.Spring.Core.IO.IResourceLoader"/> used to resolve
		/// the string.
		/// </returns>
