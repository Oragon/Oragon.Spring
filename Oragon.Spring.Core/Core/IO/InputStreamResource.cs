...
namespace Oragon.Spring.Core.IO
{
	...
	/// <remarks>
	/// <p>
	/// Should only be used if no other <see cref="Oragon.Spring.Core.IO.IResource"/>
	/// implementation is applicable.
	/// </p>
	/// <p>
	/// In contrast to other <see cref="Oragon.Spring.Core.IO.IResource"/>
	/// implementations, this is an adapter for an <i>already opened</i>
	/// resource - the <see cref="Oragon.Spring.Core.IO.InputStreamResource.IsOpen"/>
	...
	public class InputStreamResource : AbstractResource
	{
		...
		/// <see cref="Oragon.Spring.Core.IO.InputStreamResource"/> class.
		/// </summary>
