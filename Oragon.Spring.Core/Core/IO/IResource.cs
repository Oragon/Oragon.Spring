...
{
	/// <summary>
    /// The central abstraction for Oragon.Spring.NET's access to resources such as
	...
	/// Oragon.Spring.NET's resource handling. Third party extensions or libraries
	/// that want to integrate external resources with Oragon.Spring.NET's IoC
	...
	/// <see cref="Oragon.Spring.Core.IO.IResource"/> implementation integrate nicely
	/// with the <see cref="Oragon.Spring.Core.IO.ConfigurableResourceLoader"/> class.
	/// </p>
	/// </remarks>
	/// <author>Juergen Hoeller</author>
	/// <author>Rick Evans (.NET)</author>
	/// <seealso cref="Oragon.Spring.Core.IO.IResourceLoader"/>
	...
	public interface IResource : IInputStreamSource
	{
		...
		/// <see cref="Oragon.Spring.Core.IO.IResource.Exists"/> property prior to
		...
		/// <see cref="Oragon.Spring.Core.IO.IResource.Exists"/> property.
		/// </p>
		/// </remarks>
		/// <value>
