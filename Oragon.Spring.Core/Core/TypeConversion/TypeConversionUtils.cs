...
namespace Oragon.Spring.Core.TypeConversion
{
    /// <summary>
    ...
    public class TypeConversionUtils
    {
        ...
        public static object ConvertValueIfNecessary(Type requiredType, object newValue, string propertyName)
        {
            if (newValue != null)
            {
                ...
                if (requiredType != null && requiredType.IsGenericType && TypeImplementsGenericInterface(requiredType, typeof(Oragon.Spring.Collections.Generic.ISet<>)))
                {
                    // convert individual elements to array elements
                    ...
                    {
                        ICollection elements = (ICollection)newValue;
                        return ToTypedCollectionWithTypeConversion(typeof(Oragon.Spring.Collections.Generic.HashedSet<>), componentType, elements, propertyName);
                    }
                }
        ...
        /// <returns>
        /// A new <see cref="Oragon.Spring.Core.PropertyChangeEventArgs"/>.
        /// </returns>
