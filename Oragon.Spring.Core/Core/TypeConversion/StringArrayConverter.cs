...
namespace Oragon.Spring.Core.TypeConversion
{
    ...
    /// <see cref="Oragon.Spring.Core.TypeConversion.StringArrayConverter.ListSeparator"/>
	...
	/// automatically registered with any <see cref="Oragon.Spring.Objects.IObjectWrapper"/>
	/// implementations.
	/// </p>
	/// </remarks>
	/// <example>
