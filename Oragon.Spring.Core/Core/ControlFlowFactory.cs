...
namespace Oragon.Spring.Core
{
	/// <summary>
	/// Factory class to conceal any default <see cref="Oragon.Spring.Core.IControlFlow"/> implementation.
	/// </summary>
	...
	{
		/// <summary>
		/// Creates a new instance of the <see cref="Oragon.Spring.Core.IControlFlow"/>
		/// implementation provided by this factory.
		/// </summary>
		/// <returns>
		/// A new instance of the <see cref="Oragon.Spring.Core.IControlFlow"/>
		/// implementation provided by this factory.
		/// </returns>
		...
		private class DefaultControlFlow : IControlFlow
		{
			...
			/// <see cref="Oragon.Spring.Core.ControlFlowFactory.DefaultControlFlow"/> class.
			/// </summary>
			...
			/// </summary>
			/// <seealso cref="Oragon.Spring.Core.IControlFlow.Under(Type)"/>
			...
			/// </p>
			/// </remarks>
			/// <seealso cref="Oragon.Spring.Core.IControlFlow.Under(Type, string)"/>
			...
			/// </p>
			/// </remarks>
			/// <seealso cref="Oragon.Spring.Core.IControlFlow.UnderToken(string)"/>
