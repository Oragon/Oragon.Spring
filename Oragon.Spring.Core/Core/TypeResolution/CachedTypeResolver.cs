...
namespace Oragon.Spring.Core.TypeResolution
{
	...
	public class CachedTypeResolver : ITypeResolver
	{
		...
		/// <summary>
		/// Creates a new instance of the <see cref="Oragon.Spring.Core.TypeResolution.CachedTypeResolver"/> class.
		/// </summary>
		/// <param name="typeResolver">
		/// The <see cref="Oragon.Spring.Core.TypeResolution.ITypeResolver"/> that this instance will delegate
