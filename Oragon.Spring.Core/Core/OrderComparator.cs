...
{
    /// <summary>
    /// Comparator implementation for <see cref="Oragon.Spring.Core.IOrdered"/> objects, sorting by
    /// order value ascending (resp. by priority descending).
    /// </summary>
    /// <remarks>
    /// <p>
    /// Non-<see cref="Oragon.Spring.Core.IOrdered"/> objects are treated as greatest order values,
    /// thus ending up at the end of a list, in arbitrary order (just like same order values of
    /// <see cref="Oragon.Spring.Core.IOrdered"/> objects).
    /// </p>
    /// </remarks>
