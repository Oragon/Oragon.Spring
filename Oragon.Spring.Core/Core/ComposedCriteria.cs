...
{
    /// <summary>
    /// A <see cref="Oragon.Spring.Core.ICriteria"/> implementation that represents
    /// a composed collection of <see cref="Oragon.Spring.Core.ICriteria"/> instances.
    /// </summary>
    public class ComposedCriteria : ICriteria
    {
        ...
        /// </summary>
        /// <param name="criteria">
        /// The <see cref="Oragon.Spring.Core.ICriteria"/> to be added.
        /// </param>
        ...
        /// <summary>
        /// The list of <see cref="Oragon.Spring.Core.ICriteria"/> composing this
        /// instance.
        /// </summary>
