...
{
    /// <summary>
    /// <see cref="Oragon.Spring.Collections.DictionarySet"/> is an
    /// <see langword="abstract"/> class that supports the creation of new
    /// <see cref="Oragon.Spring.Collections.ISet"/> types where the underlying data
    ...
    /// <see cref="Oragon.Spring.Collections.ISet"/> using it.
    /// </p>
    /// <p>
    ...
    /// the <see cref="Oragon.Spring.Collections.DictionarySet"/> class is mutable.
    /// Therefore, it is not safe to use as a key value in a dictionary.
    /// </p>
    /// <p>
    /// To make a <see cref="Oragon.Spring.Collections.ISet"/> typed based on your
    /// own <see cref="System.Collections.IDictionary"/>, simply derive a new
    /// class with a constructor that takes no parameters. Some
    /// <see cref="Oragon.Spring.Collections.ISet"/> implmentations cannot be defined
    ...
    /// <see cref="Oragon.Spring.Collections.ISet"/> as an argument.
    /// </p>
    /// </remarks>
    /// <seealso cref="Oragon.Spring.Collections.ISet"/>
    [Serializable]
    public abstract class DictionarySet : Set
    {
        ...
        /// <see cref="Oragon.Spring.Collections.ISet"/>s.
        /// </remarks>
        ...
        /// <summary>
        /// Copies the elements in the <see cref="Oragon.Spring.Collections.ISet"/> to
        /// an array.
        /// </summary>
        /// <remarks>
        /// <p>
        /// The type of array needs to be compatible with the objects in the
        /// <see cref="Oragon.Spring.Collections.ISet"/>, obviously.
        /// </p>
        /// </remarks>
        /// <param name="array">
        ...
        /// <see cref="Oragon.Spring.Collections.ISet"/> is synchronized across
        /// threads.
        /// </summary>
        /// <seealso cref="Oragon.Spring.Collections.Set.IsSynchronized"/>
        ...
        /// it thread-safe.
        /// </value>
        /// <seealso cref="Oragon.Spring.Collections.Set.SyncRoot"/>
        ...
        /// <see cref="Oragon.Spring.Collections.ISet"/>.
        /// </summary>
        /// <returns>
        /// An <see cref="System.Collections.IEnumerator"/> over the elements
        /// in the <see cref="Oragon.Spring.Collections.ISet"/>.
        /// </returns>
