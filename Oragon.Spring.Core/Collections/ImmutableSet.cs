...
namespace Oragon.Spring.Collections
{
	...
	/// <see cref="Oragon.Spring.Collections.ISet"/> wrapper.
	/// </summary>
	/// <remarks>
	/// <p>
	/// Although this class is advertised as immutable, it really isn't.
	/// Anyone with access to the wrapped <see cref="Oragon.Spring.Collections.ISet"/>
	/// can still change the data. So <see cref="System.Object.GetHashCode"/>
	/// is not implemented for this <see cref="Oragon.Spring.Collections.ISet"/>, as
	/// is the case for all <see cref="Oragon.Spring.Collections.ISet"/>
	/// implementations in this library. This design decision was based on the
	/// efficiency of not having to <b>clone</b> the wrapped
	/// <see cref="Oragon.Spring.Collections.ISet"/> every time you wrap a mutable
    ...
    public sealed class ImmutableSet : Set
	{
		...
		/// </summary>
		/// <param name="basisSet">
		/// The <see cref="Oragon.Spring.Collections.ISet"/> that is to be wrapped.
		/// </param>
		...
		/// <returns>
		/// A new <see cref="Oragon.Spring.Collections.ISet"/> containing the union of
		/// this <see cref="Oragon.Spring.Collections.ISet"/> with the specified
		/// collection. Neither of the input objects is modified by the union.
		/// </returns>
		/// <see cref="Oragon.Spring.Collections.ISet.Union(ISet)"/>
		...
		/// </returns>
		/// <see cref="Oragon.Spring.Collections.ISet.Intersect(ISet)"/>
		...
		/// </returns>
		/// <seealso cref="Oragon.Spring.Collections.ISet.Minus(ISet)"/>
		...
		/// </returns>
		/// <seealso cref="Oragon.Spring.Collections.ISet.ExclusiveOr(ISet)"/>
