...
namespace Oragon.Spring.Collections
{
    ...
    public class LinkedList : IList
	{
		...
		/// <see cref="Oragon.Spring.Collections.LinkedList"/> class.
		/// </summary>
		public LinkedList()
		{
		...
		/// <summary>
		/// Creates a new instance of the
		/// <see cref="Oragon.Spring.Collections.LinkedList"/> class that contains all
		...
		/// <see cref="Oragon.Spring.Collections.LinkedList"/> to make it thread-safe.
		/// </summary>
		/// <value>
		/// An object that can be used to synchronize this
		/// <see cref="Oragon.Spring.Collections.LinkedList"/> to make it thread-safe.
		...
		/// <see cref="Oragon.Spring.Collections.LinkedList"/>.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// in the <see cref="Oragon.Spring.Collections.LinkedList"/>.
		/// </returns>
