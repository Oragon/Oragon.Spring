...
{
	/// <summary>
	/// Implements a thread-safe <see cref="Oragon.Spring.Collections.ISet"/> wrapper.
	/// </summary>
	/// <remarks>
	/// <p>
    ...
    public sealed class SynchronizedSet : Set
	{
		...
		/// <summary>
		/// Constructs a thread-safe <see cref="Oragon.Spring.Collections.ISet"/>
		/// wrapper.
		/// </summary>
		/// <param name="basisSet">
		/// The <see cref="Oragon.Spring.Collections.ISet"/> object that this object
		/// will wrap.
		/// </param>
		...
		/// <summary>
		/// Returns a clone of the <see cref="Oragon.Spring.Collections.ISet"/> instance.  
		/// </summary>
