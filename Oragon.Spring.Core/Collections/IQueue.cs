...
namespace Oragon.Spring.Collections
{
	/// <summary>
	...
	/// <see cref="Oragon.Spring.Collections.IQueue.Remove"/> or
	/// <see cref="Oragon.Spring.Collections.IQueue.Poll"/>. In a FIFO queue, all new
	...
	/// </p>
	/// <p>
	/// The <see cref="Oragon.Spring.Collections.IQueue.Offer(object)"/> method inserts an
	/// element if possible, otherwise returning <see lang="false"/>. This differs from the 
	/// <see cref="Oragon.Spring.Collections.IQueue.Add(object)"/> method, which can fail to
	/// add an element only by throwing an exception. The
	/// <see cref="Oragon.Spring.Collections.IQueue.Offer(object)"/> method is designed for
	/// use when failure is a normal, rather than exceptional occurrence, for example,
	/// in fixed-capacity (or "bounded" queues.
	/// </p>
	/// <p>
	/// The <see cref="Oragon.Spring.Collections.IQueue.Remove()"/>
	/// <see cref="Oragon.Spring.Collections.IQueue.Poll()"/> methods remove and
	...
	/// <see cref="Oragon.Spring.Collections.IQueue.Remove()"/> and
	/// <see cref="Oragon.Spring.Collections.IQueue.Poll()"/> methods differ only in their
	/// behavior when the queue is empty: the
	/// <see cref="Oragon.Spring.Collections.IQueue.Remove()"/> method throws an exception,
	/// while the <see cref="Oragon.Spring.Collections.IQueue.Poll()"/> method returns
	/// <see lang="null"/>.
	/// </p>
	/// <p>
	/// The <see cref="Oragon.Spring.Collections.IQueue.Element()"/> and
	/// <see cref="Oragon.Spring.Collections.IQueue.Peek()"/> methods return, but do
	...
	/// <see cref="Oragon.Spring.Collections.IQueue.Poll()"/> method to
	...
	public interface IQueue : ICollection
	{
		...
		/// preferable to <see cref="Oragon.Spring.Collections.IQueue.Add(object)"/>,
		...
		/// <remarks>
		/// <p>
		/// This method differs from <see cref="Oragon.Spring.Collections.IQueue.Poll()"/>
		...
		/// </returns>
		/// <exception cref="Oragon.Spring.Collections.NoElementsException">if this queue is empty</exception>
		object Remove();
		...
		/// <remarks>
		/// <p>
		/// This method differs from <see cref="Oragon.Spring.Collections.IQueue.Peek()"/>
		/// only in that it throws an exception if this queue is empty.
		/// </p>
		/// </remarks>
		/// <returns> 
