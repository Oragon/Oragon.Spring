...
namespace Oragon.Spring.Collections
{
	...
	/// <see cref="Oragon.Spring.Collections.AbstractQueue.Add(object)"/>,
	/// <see cref="Oragon.Spring.Collections.AbstractQueue.Remove()"/>, and
	/// <see cref="Oragon.Spring.Collections.AbstractQueue.Element()"/> are based on
	/// the <see cref="Oragon.Spring.Collections.AbstractQueue.Offer(object)"/>,
	/// <see cref="Oragon.Spring.Collections.AbstractQueue.Poll()"/>, and
	/// <see cref="Oragon.Spring.Collections.AbstractQueue.Peek()"/> methods
	...
	/// <see cref="Oragon.Spring.Collections.AbstractQueue.Offer(object)"/> which does
	/// not permit the insertion of <see lang="null"/> elements, along with methods 
	/// <see cref="Oragon.Spring.Collections.AbstractQueue.Poll()"/>, and
	/// <see cref="Oragon.Spring.Collections.AbstractQueue.Peek()"/>. Typically,
	...
	{
		/// <summary>
		/// Creates a new instance of the <see cref="Oragon.Spring.Collections.AbstractQueue"/> class.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <see cref="Oragon.Spring.Collections.AbstractQueue.Poll()"/> only in that
		...
		/// <remarks>
		/// <p>
		/// This method differs from <see cref="Oragon.Spring.Collections.AbstractQueue.Peek()"/>
		/// only in that it throws an exception if this queue is empty.
		/// </p>
		/// <p>
		/// ALso note that this implementation returns the result of
		/// <see cref="Oragon.Spring.Collections.AbstractQueue.Peek()"/> unless the queue
		/// is empty.
		/// </p>
		/// </remarks>
		...
		/// <see cref="Oragon.Spring.Collections.AbstractQueue.Poll()"/> until it
		...
		/// <p>
		/// Attempts to
		/// <see cref="Oragon.Spring.Collections.AbstractQueue.AddAll(ICollection)"/>
		...
		/// If the collection is the current <see cref="Oragon.Spring.Collections.IQueue"/> or 
