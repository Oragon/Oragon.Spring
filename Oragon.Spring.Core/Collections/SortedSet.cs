...
{
	/// <summary>
	/// Implements an <see cref="Oragon.Spring.Collections.ISet"/> based on a sorted
	/// tree.
	/// </summary>
	/// <remarks>
	/// <p>
	...
	/// <see cref="Oragon.Spring.Collections.HashedSet"/>. However, iteration occurs
	/// in order.
	/// </p>
	/// <p>
	...
	/// </p>
	/// <p>
	/// This <see cref="Oragon.Spring.Collections.ISet"/> implementation does
