...
namespace Oragon.Spring.Collections
{
    ...
    public abstract class Set : ISet
	{
		...
		/// <summary>
		/// This method will test the <see cref="Oragon.Spring.Collections.ISet"/>
		/// against another <see cref="Oragon.Spring.Collections.ISet"/> for
		/// "equality".
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <see cref="Oragon.Spring.Collections.ISet"/> instances, use
		/// <c>Equals()</c>. If you wish to check to see if two references are
		/// actually the same object, use "==" and "!=".  
		/// </p>
		/// </remarks>
		/// <param name="obj">
		/// A <see cref="Oragon.Spring.Collections.ISet"/> object to compare to.
		/// </param>
		/// <returns>
