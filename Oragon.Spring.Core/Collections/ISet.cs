...
namespace Oragon.Spring.Collections
{
	...
	/// <see cref="Oragon.Spring.Collections.ISet"/> abstraction. The order of
	/// elements in a set is dependant on (a)the data-structure implementation, and 
	/// (b)the implementation of the various
	/// <see cref="Oragon.Spring.Collections.ISet"/> methods, and thus is not
	/// guaranteed.
	/// </p>
	/// <p>
	/// <see cref="Oragon.Spring.Collections.ISet"/> overrides the
	...
	/// store collection objects inside <see cref="Oragon.Spring.Collections.ISet"/>
	/// instances. You would typically want to use a keyed
	/// <see cref="System.Collections.IDictionary"/> instead.
	/// </p>
	/// <p>
	/// None of the <see cref="Oragon.Spring.Collections.ISet"/> implementations in
	/// this library are guaranteed to be thread-safe in any way unless wrapped
	/// in a <see cref="Oragon.Spring.Collections.SynchronizedSet"/>.
	/// </p>
	/// <p>
	/// The following table summarizes the binary operators that are supported
	/// by the <see cref="Oragon.Spring.Collections.ISet"/> class.
	/// </p>
	/// <list type="table">
	///		<listheader>
	///			<term>Operation</term>
	...
	public interface ISet : ICollection, ICloneable
	{
		...
		/// <see cref="Oragon.Spring.Collections.ISet"/> containing the elements from
		/// the operation.
		/// </p>
		/// </remarks>
		/// <param name="setOne">A set of elements.</param>
