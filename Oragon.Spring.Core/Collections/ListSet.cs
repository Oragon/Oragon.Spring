...
{
	/// <summary>
	/// Implements a <see cref="Oragon.Spring.Collections.ISet"/> based on a list.
	/// </summary>
	/// <remarks>
	/// <p>
	/// Performance is much better for very small lists than either
	/// <see cref="Oragon.Spring.Collections.HashedSet"/> or <see cref="Oragon.Spring.Collections.SortedSet"/>.
	/// However, performance degrades rapidly as the data-set gets bigger. Use a
	/// <see cref="Oragon.Spring.Collections.HybridSet"/> instead if you are not sure your data-set
	...
	/// <see cref="Oragon.Spring.Collections.ISet"/> mathematical operators.  
	/// </p>
	/// </remarks>
    [Serializable]
