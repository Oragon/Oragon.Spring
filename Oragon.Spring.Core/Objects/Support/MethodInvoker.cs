...
namespace Oragon.Spring.Objects.Support
{
	/// <summary>
	...
	/// <see cref="Oragon.Spring.Objects.Factory.Config.MethodInvokingFactoryObject"/>.
	/// </p>
	/// <p>
	...
	public class MethodInvoker
	{
		...
		/// <summary>
		/// Creates a new instance of the <see cref="Oragon.Spring.Objects.Support.MethodInvoker"/> class.
		/// </summary>
		...
		/// </p>
		/// </remarks>
		/// <seealso cref="Oragon.Spring.Objects.Support.MethodInvoker.TargetObject"/>
		...
		/// <see cref="Oragon.Spring.Objects.Support.MethodInvoker"/> class if this is not clear).
		/// </p>
		/// <p>
		...
		/// </p>
		/// </remarks>
		/// <seealso cref="Oragon.Spring.Objects.Support.MethodInvoker.NamedArguments"/>
		...
		/// <see cref="Oragon.Spring.Objects.Support.MethodInvoker.Prepare"/> method). It is a combination of the
		...
		/// previously prepared arguments... another call to the <see cref="Oragon.Spring.Objects.Support.MethodInvoker.Prepare"/>
		/// method will then be required to prepare the arguments again (or the prepared arguments
		/// can be set explicitly if so desired).
		/// </p>
		/// </remarks>
		/// <seealso cref="Oragon.Spring.Objects.Support.MethodInvoker.Arguments"/>
		/// <seealso cref="Oragon.Spring.Objects.Support.MethodInvoker.NamedArguments"/>
		...
		/// <see cref="Oragon.Spring.Objects.Support.MethodInvoker.Prepare"/> method).
		/// </p>
		/// </remarks>
		/// <returns>
		/// The object returned by the method invocation, or
		/// <see cref="Oragon.Spring.Objects.Support.MethodInvoker.Void"/> if the method returns void.
		/// </returns>
		/// <exception cref="MethodInvocationException">
		/// If at least one of the arguments passed to this <see cref="Oragon.Spring.Objects.Support.MethodInvoker"/>
