...
{
	/// <summary>
	/// Describes an <see cref="Oragon.Spring.Objects.IEventHandlerValue"/> implementation
	...
	public class AutoWiringEventHandlerValue : AbstractEventHandlerValue
	{
		...
		/// <see cref="Oragon.Spring.Objects.Support.AutoWiringEventHandlerValue"/> class.
		/// </summary>
		...
		/// <see cref="Oragon.Spring.Objects.IEventHandlerValue"/> implementation (such as
		/// <see cref="Oragon.Spring.Objects.Support.InstanceEventHandlerValue"/> or
		/// <see cref="Oragon.Spring.Objects.Support.StaticEventHandlerValue"/>) to do the heavy lifting of
		...
		private sealed class AutoWirer
		{
			...
			/// <summary>
			/// Creates a new instance of the
			/// <see cref="Oragon.Spring.Objects.Support.AutoWiringEventHandlerValue.AutoWirer"/> class.
			/// </summary>
			/// <param name="source">
