...
namespace Oragon.Spring.Objects.Support
{
	...
	/// <see cref="Oragon.Spring.Objects.Support.ISortDefinition"/> interface that
	...
	public class MutableSortDefinition : ISortDefinition
	{
		...
		/// <see cref="Oragon.Spring.Objects.Support.MutableSortDefinition"/> class.
		/// </summary>
		...
		/// <summary>
        /// Creates a new instance of the
        /// <see cref="Oragon.Spring.Objects.Support.MutableSortDefinition"/> class using
        /// the specified <see cref="Oragon.Spring.Objects.Support.ISortDefinition"/>.
		/// </summary>
		/// <param name="source">
		/// The <see cref="Oragon.Spring.Objects.Support.ISortDefinition"/> to use
		...
		/// Whether or not the
		/// <see cref="Oragon.Spring.Objects.Support.MutableSortDefinition.Ascending"/>
		/// property should be toggled if the same name is set on the
		/// <see cref="Oragon.Spring.Objects.Support.MutableSortDefinition.Property"/>
		/// property.
		/// </param>
