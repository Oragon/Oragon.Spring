...
{
    /// <summary> 
    /// The central interface of Oragon.Spring.NET's low-level object infrastructure.
    /// </summary>
    /// <remarks>
    /// <p>
    /// Typically not directly used by application code but rather implicitly
    /// via an <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>.
    /// </p>
    /// <p>
    ...
    /// </p>
    /// <p>
    /// <see cref="Oragon.Spring.Objects.IObjectWrapper"/> implementations can be used
    ...
    public interface IObjectWrapper
    {
    	...
    	/// <see cref="Oragon.Spring.Objects.IObjectWrapper.SetPropertyValue(PropertyValue)"/>
    	...
    	/// <see cref="Oragon.Spring.Objects.PropertyAccessExceptionsException"/> containing
    	...
    	/// <see cref="Oragon.Spring.Objects.IObjectWrapper.SetPropertyValues(IPropertyValues,bool)"/>
    	/// with an argument of <c>false</c> for the second parameter.
    	/// </p>
    	/// </remarks>
    	/// <param name="values">
    	/// The collection of <see cref="Oragon.Spring.Objects.PropertyValue"/> instances to
    	...
    	/// </remarks>
    	/// <param name="values">
    	/// The <see cref="Oragon.Spring.Objects.IPropertyValues"/> to set on the target object
    	/// </param>
