...
namespace Oragon.Spring.Objects.Factory.Support
{
    ...
    public sealed class ReplacedMethodOverride : MethodOverride
	{
		...
		/// The object name of the <see cref="Oragon.Spring.Objects.Factory.Support.IMethodReplacer"/>
		...
		/// contains only whitespace character(s).
		/// </exception>
		/// <seeaso cref="Oragon.Spring.Objects.Factory.Support.MethodOverride.Matches(MethodInfo)"/> 
