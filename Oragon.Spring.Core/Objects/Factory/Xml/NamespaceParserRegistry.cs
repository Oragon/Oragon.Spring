...
namespace Oragon.Spring.Objects.Factory.Xml
{
    ...
    public class NamespaceParserRegistry
    {
        ...
        static NamespaceParserRegistry()
        {
            ...
            wellknownNamespaceParserTypeNames["http://www.springframework.net/tx"] = "Oragon.Spring.Transaction.Config.TxNamespaceParser, Oragon.Spring.Data";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/aop"] = "Oragon.Spring.Aop.Config.AopNamespaceParser, Oragon.Spring.Aop";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/context"] = "Oragon.Spring.Context.Config.ContextNamespaceParser, Oragon.Spring.Core";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/db"] = "Oragon.Spring.Data.Config.DatabaseNamespaceParser, Oragon.Spring.Data";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/database"] = "Oragon.Spring.Data.Config.DatabaseNamespaceParser, Oragon.Spring.Data";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/remoting"] = "Oragon.Spring.Remoting.Config.RemotingNamespaceParser, Oragon.Spring.Services";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/wcf"] = "Oragon.Spring.ServiceModel.Config.WcfNamespaceParser, Oragon.Spring.Services";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/nms"] = "Oragon.Spring.Messaging.Nms.Config.NmsNamespaceParser, Oragon.Spring.Messaging.Nms";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/ems"] = "Oragon.Spring.Messaging.Ems.Config.EmsNamespaceParser, Oragon.Spring.Messaging.Ems";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/validation"] = "Oragon.Spring.Validation.Config.ValidationNamespaceParser, Oragon.Spring.Core";
            wellknownNamespaceParserTypeNames["http://www.springframework.net/nvelocity"] = "Oragon.Spring.Template.Velocity.Config.TemplateNamespaceParser, Oragon.Spring.Template.Velocity";
        ...
        internal static bool RegisterWellknownNamespaceParserType(string namespaceUri)
        {
            ...
            if (wellknownNamespaceParserTypeNames.Contains(namespaceUri))
            {
                ...
                // assume, that all Oragon.Spring.XXX assemblies have same version + public key
                // get the ", Version=x.x.x.x, Culture=neutral, PublicKeyToken=65e474d141e25e07" part of Oragon.Spring.Core and append it
        ...
        /// (can be any valid Oragon.Spring.NET resource URI).
        /// </param>
