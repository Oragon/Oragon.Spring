...
{
    /// <summary>
    /// Creates an <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> instance
    ...
    /// <see cref="Oragon.Spring.Context.IApplicationContext"/>, and instantiate it
    /// via the use of the <see cref="Oragon.Spring.Context.Support.ContextHandler"/>
    /// class (which is similar in functionality to this class). This class is
    /// provided for those times when only an
    /// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> is required.
    /// </p>
    ...
    public class ObjectFactorySectionHandler : IConfigurationSectionHandler
    {
        ...
        /// <summary>
        /// Creates a <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>
        ...
        /// </param>
        /// <returns>
        /// A <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> instance
        /// populated with the object definitions supplied in the configuration
        /// section.
        /// </returns>
