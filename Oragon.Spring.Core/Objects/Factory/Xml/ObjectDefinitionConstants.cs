...
namespace Oragon.Spring.Objects.Factory.Xml
{
	...
	/// Oragon.Spring.NET XML object definition format.
	/// </summary>
	...
	public sealed class ObjectDefinitionConstants
	{
		...
		/// (<see cref="Oragon.Spring.Objects.Factory.Xml.ObjectDefinitionConstants.ObjectNameDelimiters"/>).
		/// </p>
		/// <p>
		/// Always optional.
		/// </p>
		...
		/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory.GetObject(string)"/> with the id), or a
		...
		/// <remarks>
		/// <p>
		/// Oragon.Spring.NET supports primitives, references to other objects in the
		...
		/// to <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> behaviour.
		/// </p>
		/// <p>
		...
		/// <summary>
		/// A Oragon.Spring.NET map is a mapping from a string key to object (a .NET
		...
		/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactoryAware"/> interface,
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Support.IMethodReplacer"/> interface.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// </summary>
		/// <seealso cref="Oragon.Spring.Objects.Factory.Xml.ObjectDefinitionConstants.ReplacedMethodReplacerNameAttribute"/> 
		...
		/// </p>
		/// </remarks>
		/// <seealso cref="Oragon.Spring.Objects.Factory.Xml.ObjectDefinitionConstants.ReplacedMethodArgumentTypeElement"/> 
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Xml.ObjectDefinitionConstants"/>
		/// class.
		/// </summary>
		/// <remarks>
		/// <p>
