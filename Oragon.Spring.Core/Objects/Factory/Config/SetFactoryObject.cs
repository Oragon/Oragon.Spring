...
{
	/// <summary>
	/// Simple factory object for shared <see cref="Oragon.Spring.Collections.ISet"/> instances.
	/// </summary>
    ...
    public class SetFactoryObject : AbstractFactoryObject
	{
		...
		/// <summary>
		/// Set the source <see cref="Oragon.Spring.Collections.ISet"/>.
		/// </summary>
		/// <remarks>
		/// <p>
		/// This value will be used to populate the <see cref="Oragon.Spring.Collections.ISet"/>
		...
		/// <summary>
		/// Set the <see cref="System.Type"/> of the <see cref="Oragon.Spring.Collections.ISet"/>
		/// implementation to use.
		/// </summary>
		/// <remarks>
		/// <p>
		/// The default is the <see cref="Oragon.Spring.Collections.HybridSet"/> <see cref="System.Type"/>.
		/// </p>
		/// </remarks>
		...
		/// </summary>
		/// <value>
		/// Always returns the <see cref="Oragon.Spring.Collections.ISet"/> <see cref="System.Type"/>.
		/// </value>
		...
		/// </summary>
		/// <returns>The new <see cref="Oragon.Spring.Collections.ISet"/> instance.</returns>
