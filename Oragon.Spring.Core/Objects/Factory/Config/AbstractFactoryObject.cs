...
{
	/// <summary>
	/// Simple template superclass for <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/>
	...
	/// <see cref="Oragon.Spring.Objects.Factory.Config.AbstractFactoryObject.CreateInstance"/>
    ...
    public abstract class AbstractFactoryObject : IFactoryObject, IInitializingObject, IDisposable
	{
		...
		/// Oragon.Spring.NET IoC container really is a programming error. This
		...
		/// </exception>
		/// <seealso cref="Oragon.Spring.Objects.Factory.IInitializingObject.AfterPropertiesSet"/>
		...
		/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> in the case of
