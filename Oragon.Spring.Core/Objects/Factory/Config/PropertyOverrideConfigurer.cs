...
namespace Oragon.Spring.Objects.Factory.Config
{
	...
	/// <seea cref="Oragon.Spring.Objects.Factory.Config.PropertyPlaceholderConfigurer"/>
	/// class instead.
	/// </p>
	/// <p>
	/// In contrast to the
	...
	/// one or more
	/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyOverrideConfigurer"/>s
