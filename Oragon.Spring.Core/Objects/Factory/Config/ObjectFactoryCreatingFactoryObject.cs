...
namespace Oragon.Spring.Objects.Factory.Config
{
	...
	/// <see cref="Oragon.Spring.Objects.Factory.IGenericObjectFactory"/> that
	...
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>, which would be a
	/// violation of the inversion of control principle. With the use of this
	/// class, the client object can be fed an
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> as a property
	/// that directly returns one target <b>prototype</b> object.
	/// </p>
	/// <p>
	/// The object referred to by the value of the
	/// <see cref="Oragon.Spring.Objects.Factory.Config.ObjectFactoryCreatingFactoryObject.TargetObjectName"/>
	...
	///		type="Oragon.Spring.Objects.Factory.Config.ObjectFactoryCreatingFactoryObject">
		...
		: AbstractFactoryObject, IObjectFactoryAware
	{
		...
		/// </exception>
		/// <seealso cref="Oragon.Spring.Objects.Factory.Config.AbstractFactoryObject.AfterPropertiesSet"/>
