...
namespace Oragon.Spring.Objects.Factory.Config
{
	...
	/// object in a Oragon.Spring.NET container, and so custom placeholder prefix
	...
	/// </example>
	/// <p>
	/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyPlaceholderConfigurer"/>
	/// checks simple property values, lists, dictionaries, sets, constructor
	/// values, object type name, and object names in
	/// runtime object references (
	/// <see cref="Oragon.Spring.Objects.Factory.Config.RuntimeObjectReference"/>).
	...
	/// <p>
	/// In contrast to the
	/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyOverrideConfigurer"/>
	...
	/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyResourceConfigurer.Properties"/>
	...
	/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyPlaceholderConfigurer.IgnoreUnresolvablePlaceholders"/>
	/// property is currently set to <see langword="false"/>, an
	/// <see cref="Oragon.Spring.Objects.Factory.ObjectDefinitionStoreException"/>
	...
	/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyResourceConfigurer.Locations"/>
	...
	/// <seealso cref="Oragon.Spring.Objects.Factory.Config.PropertyResourceConfigurer"/>
	/// <seealso cref="Oragon.Spring.Objects.Factory.Config.PropertyOverrideConfigurer"/>
	/// <seealso cref="Oragon.Spring.Objects.Factory.Config.IObjectDefinition"/>
    [Serializable]
    public class PropertyPlaceholderConfigurer : PropertyResourceConfigurer
	{
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Config.EnvironmentVariableMode"/>
	    ...
	    /// <see cref="Oragon.Spring.Objects.Factory.Config.IConfigurableListableObjectFactory"/>.
	    /// </summary>
	    /// <param name="factory">
	    /// The <see cref="Oragon.Spring.Objects.Factory.Config.IConfigurableListableObjectFactory"/>
		...
		/// </returns>
		/// <seelso cref="Oragon.Spring.Objects.Factory.Config.EnvironmentVariableMode"/>
		protected virtual string ResolvePlaceholder(string placeholder,
		                                            NameValueCollection props,
		                                            EnvironmentVariableMode mode)
		{
			string propertyValue = null;
			if (mode == Oragon.Spring.Objects.Factory.Config.EnvironmentVariableMode.Override)
			{
			...
			if (propertyValue == null
				&& mode == Oragon.Spring.Objects.Factory.Config.EnvironmentVariableMode.Fallback)
			{
				propertyValue = Environment.GetEnvironmentVariable(placeholder);
			}
