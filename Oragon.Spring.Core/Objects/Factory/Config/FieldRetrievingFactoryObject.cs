...
namespace Oragon.Spring.Objects.Factory.Config
{
    ...
    /// </p>
    /// <code escaped="true">
    /// <object id="dbnull" type="Oragon.Spring.Objects.Factory.Config.FieldRetrievingFactoryObject, Oragon.Spring.Core">
    ...
    /// <see cref="Oragon.Spring.Objects.Factory.Config.FieldRetrievingFactoryObject.StaticField"/>
    /// property, like so...
    /// </p>
    /// <code escaped="true">
    /// <object id="dbnull" type="Oragon.Spring.Objects.Factory.Config.FieldRetrievingFactoryObject, Oragon.Spring.Core">
    ...
    /// </code>
    /// <p>
    /// This class also implements the <see cref="Oragon.Spring.Objects.Factory.IObjectNameAware"/>
    /// interface
    /// (<see cref="Oragon.Spring.Objects.Factory.Config.FieldRetrievingFactoryObject.ObjectName"/>).
    /// If the id (or name) of one's
    /// <see cref="Oragon.Spring.Objects.Factory.Config.FieldRetrievingFactoryObject"/>
    ...
    ///         type="Oragon.Spring.Objects.Factory.Config.FieldRetrievingFactoryObject, Oragon.Spring.Core"/>
    ///
    ...
    public class FieldRetrievingFactoryObject : IFactoryObject, IInitializingObject, IObjectNameAware
    {
        ...
        /// <p>
        /// If the
        /// <see cref="Oragon.Spring.Objects.Factory.Config.FieldRetrievingFactoryObject.TargetObject"/>
