...
namespace Oragon.Spring.Objects.Factory.Config
{
	...
	/// a Oragon.Spring.NET IoC container, i.e. the elements themselves will be
	/// resolved at runtime by the enclosing IoC container.
	/// </p>
	/// <p>
	/// The core Oragon.Spring.NET library already provides three implementations of this interface
	/// straight out of the box; they are...
	/// </p>
	/// <list type="bullet">
	/// <item>
	/// <description>
	/// <see cref="Oragon.Spring.Objects.Factory.Config.ManagedList"/>.
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	/// <see cref="Oragon.Spring.Objects.Factory.Config.ManagedDictionary"/>.
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	/// <see cref="Oragon.Spring.Objects.Factory.Config.ManagedSet"/>.
	/// </description>
	/// </item>
	/// </list>
	/// <p>
	...
	/// have <see cref="Oragon.Spring.Objects.Factory.Config.RuntimeObjectReference"/>s as elements
	/// that will be resolved at runtime by an appropriate Oragon.Spring.NET IoC container, just
