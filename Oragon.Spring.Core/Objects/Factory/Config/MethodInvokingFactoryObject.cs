...
{
	/// <summary>
	/// An <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> that returns a value
	...
	/// <see cref="Oragon.Spring.Objects.Factory.Config.MethodInvokingFactoryObject.GetObject()"/>
	...
	/// <see cref="Oragon.Spring.Objects.Support.MethodInvoker.TargetMethod"/> property to a string representing
	/// the <see langword="static"/> method name, with <see cref="Oragon.Spring.Objects.Support.MethodInvoker.TargetType"/> specifying
	...
	/// <see cref="Oragon.Spring.Objects.Support.MethodInvoker.TargetObject"/> property as the target object, and
	/// the <see cref="Oragon.Spring.Objects.Support.MethodInvoker.TargetMethod"/> property as the name of the
	/// method to call on that target object. Arguments for the method invocation may be
	/// specified by setting the <see cref="Oragon.Spring.Objects.Support.MethodInvoker.Arguments"/> property.
	/// </p>
	/// <p>
	...
	/// <see cref="Oragon.Spring.Objects.Factory.IInitializingObject.AfterPropertiesSet()"/>
	/// method being called after all properties have been set, as per the
	/// <see cref="Oragon.Spring.Objects.Factory.IInitializingObject"/> contract. If you are
	/// using this class outside of a Oragon.Spring.NET IoC container, you must call one of either
	/// <see cref="Oragon.Spring.Objects.Factory.IInitializingObject.AfterPropertiesSet()"/> or
	/// <see cref="Oragon.Spring.Objects.Support.MethodInvoker.Prepare()"/> yourself to ready the object's internal
	...
	/// </p>
	/// <code escaped="true">
	/// <object id="myObject" type="Oragon.Spring.Objects.Factory.Config.MethodInvokingFactoryObject, Oragon.Spring.Core">
	...
	/// <seealso cref="Oragon.Spring.Objects.Support.MethodInvoker"/>
	/// <seealso cref="Oragon.Spring.Objects.Support.ArgumentConvertingMethodInvoker"/>
    [Serializable]
    public class MethodInvokingFactoryObject : ArgumentConvertingMethodInvoker, IFactoryObject, IInitializingObject
	{
		...
		/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> contract that
		/// treats a <see langword="null"/> value as a configuration error).
		/// </p>
		/// </remarks>
		/// <seealso cref="Oragon.Spring.Objects.Factory.IFactoryObject.ObjectType"/>
		...
		/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject.IsSingleton"/>
		...
		/// </exception>
		/// <seealso cref="Oragon.Spring.Objects.Support.ArgumentConvertingMethodInvoker.Prepare()"/>
