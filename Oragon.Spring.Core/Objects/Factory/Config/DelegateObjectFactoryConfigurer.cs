...
namespace Oragon.Spring.Objects.Factory.Config
{
    ...
    /// </remarks>
    /// <example>
    /// The example below is taken from a unit test. The snippet causes 'someObject' to be registered each time <see cref="Oragon.Spring.Context.Support.AbstractApplicationContext.Refresh"/> is called on 
