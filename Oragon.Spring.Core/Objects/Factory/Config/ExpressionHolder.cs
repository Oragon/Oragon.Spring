...
namespace Oragon.Spring.Objects.Factory.Config
{
	...
	/// <see cref="Oragon.Spring.Objects.PropertyValue"/> object when it's a reference
    ...
    public class ExpressionHolder
	{
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Config.ExpressionHolder"/>
		/// class.
		/// </summary>
		...
		public ExpressionHolder(string expression)
		{
            ...
            this.expression = Oragon.Spring.Expressions.Expression.Parse(expression);
		}
