...
{
	/// <summary>
	/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> implementation that
	...
	/// </p>
	/// <p>
	/// Please note that the <see cref="Oragon.Spring.Objects.Factory.Config.PropertyPathFactoryObject"/>
	/// is an <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> implementation, and as such has
	/// to comply with the contract of the <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/>
	/// interface; more specifically, this means that the end result of the property lookup path
	/// evaluation cannot be <see lang="null"/> (<see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/>
	...
	///	-->
	/// <object id="consumer"
	///			type="Oragon.Spring.Objects.Factory.Config.PropertyPathFactoryObject, Oragon.Spring.Core">
    ...
    public class PropertyPathFactoryObject : IFactoryObject, IObjectNameAware, IObjectFactoryAware
	{
		...
		/// The target object that the property path lookup is to be applied to.
		/// </value>
		/// <seealso cref="Oragon.Spring.Objects.Factory.Config.PropertyPathFactoryObject.TargetObjectName"/> 
		...
		/// one cannot use the <see cref="Oragon.Spring.Objects.Factory.Config.PropertyPathFactoryObject"/>
		...
		/// is to be applied to.
		/// </value>
		/// <seealso cref="Oragon.Spring.Objects.Factory.Config.PropertyPathFactoryObject.TargetObject"/> 
		...
		/// this factory.
		/// </returns>
		/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject.GetObject()"/>
		...
		/// </summary>
		/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject.ObjectType"/>
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyPathFactoryObject"/>
		/// will be interpreted as "objectName.property" pattern, if neither the
		/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyPathFactoryObject.TargetObjectName"/>
		/// <see cref="Oragon.Spring.Objects.Factory.Config.PropertyPathFactoryObject.TargetObject"/>
