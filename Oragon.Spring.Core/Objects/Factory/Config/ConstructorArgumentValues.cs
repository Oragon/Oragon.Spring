...
namespace Oragon.Spring.Objects.Factory.Config
{
	...
	/// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectDefinition.ConstructorArgumentValues"/>
	[Serializable]
	public class ConstructorArgumentValues
	{
		/// <summary>
		/// Can be used as an argument filler for the
		/// <see cref="Oragon.Spring.Objects.Factory.Config.ConstructorArgumentValues.GetArgumentValue(int, string,Type,ISet)"/>
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Config.ConstructorArgumentValues.ValueHolder"/>s
		/// as values.
		/// </returns>
		...
		/// <returns>
		/// The
		/// <see cref="Oragon.Spring.Objects.Factory.Config.ConstructorArgumentValues.ValueHolder"/>
		...
		/// A <see cref="Oragon.Spring.Collections.ISet"/> of
		/// <see cref="Oragon.Spring.Objects.Factory.Config.ConstructorArgumentValues.ValueHolder"/>
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Config.ConstructorArgumentValues.NoIndex"/>.
		/// </param>
		/// <param name="name">
		/// The name of the argument in the constructor argument list. May be
		/// <see langword="null"/>.
