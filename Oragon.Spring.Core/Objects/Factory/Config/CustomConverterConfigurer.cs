...
namespace Oragon.Spring.Objects.Factory.Config
{
	...
	/// <p>
	/// Because the
	/// <see cref="Oragon.Spring.Objects.Factory.Config.CustomConverterConfigurer"/>
	/// class implements the
	/// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectFactoryPostProcessor"/>
	/// interface, instances of this class that have been exposed in the
	/// scope of an
	/// <see cref="Oragon.Spring.Context.IApplicationContext"/> will
	...
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>, no such automatic
	/// pickup of the
	/// <see cref="Oragon.Spring.Objects.Factory.Config.CustomConverterConfigurer"/>
	/// is performed (custom converters will have to be added manually using the
	/// <see cref="Oragon.Spring.Objects.Factory.Config.IConfigurableObjectFactory.RegisterCustomConverter(Type, TypeConverter)"/>
	/// method). For <i>most</i> application scenarios, one will get better
	/// mileage using the <see cref="Oragon.Spring.Context.IApplicationContext"/>
	/// abstraction.
	/// </p>
	/// </remarks>
	/// <example>
	...
	///	  type="Oragon.Spring.Objects.Factory.Config.CustomConverterConfigurer, Oragon.Spring.Core">
	...
	/// converter in place and makes it available to a Oragon.Spring.NET container for
	...
	/// </object>
	/// <object id="customConverterConfigurer" type="Oragon.Spring.Objects.Factory.Config.CustomConverterConfigurer, Oragon.Spring.Core">
	/// 	<property name="CustomConverters">
	/// 		<dictionary>
	...
	/// <seealso cref="Oragon.Spring.Context.IApplicationContext"/>
	/// <seealso cref="Oragon.Spring.Objects.Factory.Config.IConfigurableObjectFactory.RegisterCustomConverter(Type, TypeConverter)"/>
    [Serializable]
