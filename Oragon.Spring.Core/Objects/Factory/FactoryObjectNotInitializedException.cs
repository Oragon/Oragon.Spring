...
namespace Oragon.Spring.Objects.Factory
{
	...
	/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> is not fully
	...
	/// </p>
	/// <p>
	/// A circular reference with an <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/>
	/// cannot be solved by eagerly caching singleton instances (as is the
	/// case with normal objects. The reason is that every
	/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> needs to be fully
