...
{
	/// <summary>
	/// The root interface for accessing a Oragon.Spring.NET IoC container.
	/// </summary>
	/// <remarks>
	/// <para>
	/// This is the basic client view of a Oragon.Spring.NET IoC container; further interfaces
	/// such as <see cref="Oragon.Spring.Objects.Factory.IListableObjectFactory"/> and
	/// <see cref="Oragon.Spring.Objects.Factory.Config.IConfigurableObjectFactory"/>
	...
	/// source (such as an XML document), and use the <see cref="Oragon.Spring.Objects"/>
	...
	/// <see cref="Oragon.Spring.Objects.Factory.IListableObjectFactory"/>, all of the methods
	/// in this interface will also check parent factories if this is an
	/// <see cref="Oragon.Spring.Objects.Factory.IHierarchicalObjectFactory"/>. If an object is
	...
	/// <item>
	/// <description>
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectNameAware"/>'s
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectNameAware.ObjectName"/> property.
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactoryAware"/>'s
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactoryAware.ObjectFactory"/> property.
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	/// <see cref="Oragon.Spring.Context.IApplicationContextAware.ApplicationContext"/>
	/// (only applicable if running within an <see cref="Oragon.Spring.Context.IApplicationContext"/>).
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	...
	/// <item>
	/// <description>
	/// <see cref="Oragon.Spring.Objects.Factory.IInitializingObject"/>'s
	/// <see cref="Oragon.Spring.Objects.Factory.IInitializingObject.AfterPropertiesSet"/> method.
	/// </description>
	/// </item>
	/// <item>
	/// <description>
	...
	public interface IObjectFactory : IDisposable
	{
		...
		/// <remarks>
		/// <para>
		/// That is, will <see cref="Oragon.Spring.Objects.Factory.IObjectFactory.GetObject(string)"/>
		...
		/// </para>
		/// <para>
		/// This is the indexer for the <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>
		/// interface.
		/// </para>
		/// </remarks>
		...
		/// For an <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/>, returns the type
		/// of object that the <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> creates.
		/// </para>
		/// </remarks>
		/// <param name="name">The name of the object to query.</param>
		/// <returns>
		...
		/// typical Oragon.Spring.NET IOC container lifecycle for dependency injection.
		/// </para>
		/// </remarks>
		/// <example>
