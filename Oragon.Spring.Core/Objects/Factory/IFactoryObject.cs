...
namespace Oragon.Spring.Objects.Factory
{
	...
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> that are themselves
	/// factories.
	/// </summary>
	/// <remarks>
	/// <p>
	/// If an object implements this interface, it is used as a factory,
	/// not directly as an object. <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/>s
	/// can support singletons and prototypes
	/// (<see cref="Oragon.Spring.Objects.Factory.IFactoryObject.IsSingleton"/>)...
	/// please note that an <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/>
	/// itself can only ever be a singleton. It is a logic error to configure an
	/// <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/> itself to be a prototype.
	/// </p>
	/// <note type="caution">
