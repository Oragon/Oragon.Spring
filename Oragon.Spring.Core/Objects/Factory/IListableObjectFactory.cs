...
{
	/// <summary>
	/// Extension of the <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> interface
	...
	/// <remarks>
	/// <p>
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> implementations that preload
	...
	/// </p>
	/// <p>
	/// If this is an <see cref="Oragon.Spring.Objects.Factory.IHierarchicalObjectFactory"/>,
	/// the return values will not take any
	/// <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/> hierarchy into account, but
	/// will relate only to the objects defined in the current factory.
	/// Use the <see cref="Oragon.Spring.Objects.Factory.ObjectFactoryUtils"/> helper class to
	/// get all objects.
	/// </p>
	/// <p>
