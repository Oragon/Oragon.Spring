...
namespace Oragon.Spring.Objects.Factory.Attributes
{
    ...
    public class InitDestroyAttributeObjectPostProcessor : IDestructionAwareObjectPostProcessor, IObjectFactoryAware, IOrdered
    {
        ...
        /// </returns>
        /// <exception cref="T:Oragon.Spring.Objects.ObjectsException">In case of errors.
        ///             </exception>
        ...
        /// </summary>
        /// <param name="instance">The new object instance.</param><param name="name">The name of the object.</param><exception cref="T:Oragon.Spring.Objects.ObjectsException">In case of errors.
        ///             </exception>
