...
{
	/// <summary>
	/// Exception thrown when an <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>
	...
	public class NoSuchObjectDefinitionException : ObjectsException
	{
		...
		/// <see cref="Oragon.Spring.Objects.Factory.NoSuchObjectDefinitionException"/> class.
		/// </summary>
