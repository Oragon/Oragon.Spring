...
namespace Oragon.Spring.Objects.Factory
{
	...
	/// It is similar to the <see cref="Oragon.Spring.Objects.Factory.IFactoryObject"/>, but
	/// implementations of the aforementioned interface are normally meant to be defined
	/// as instances by the user in an <see cref="Oragon.Spring.Objects.Factory.IObjectFactory"/>,
	/// while implementations of this class are normally meant to be fed as a property to
	/// other objects; as such, the
	/// <see cref="Oragon.Spring.Objects.Factory.IGenericObjectFactory.GetObject"/> method
