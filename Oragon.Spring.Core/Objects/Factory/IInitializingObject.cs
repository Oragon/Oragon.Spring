...
namespace Oragon.Spring.Objects.Factory
{
	...
	/// by non-Oragon.Spring.NET framework code can be avoided (and is generally
	/// discouraged). The Oragon.Spring.NET container provides support for a generic
	...
	/// XML configuration), but removes any dependency on Oragon.Spring.NET from the
	/// class definition.
	/// </note>
	/// </remarks>
