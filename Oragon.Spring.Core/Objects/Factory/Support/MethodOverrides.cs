...
namespace Oragon.Spring.Objects.Factory.Support
{
	...
	/// methods on a managed object the Oragon.Spring.NET IoC container will override at runtime.
	/// </summary>
    ...
    public class MethodOverrides : IEnumerable
	{
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Support.MethodOverrides"/> class.
		/// </summary>
