...
{
	/// <summary>
	/// An <see cref="Oragon.Spring.Objects.Factory.Support.IInstantiationStrategy"/>
	...
	/// <see lang="abstract"/>. An <see cref="Oragon.Spring.Objects.ObjectsException"/>
    ...
    public class MethodInjectingInstantiationStrategy : SimpleInstantiationStrategy
	{
	    ...
	    /// </summary>
        private const string DYNAMIC_ASSEMBLY_NAME = "Oragon.Spring.MethodInjected";
		...
		/// <paramref name="definition"/> from the supplied <paramref name="factory"/>.
		/// </returns>
		/// <seealso cref="Oragon.Spring.Objects.Factory.Support.SimpleInstantiationStrategy.InstantiateWithMethodInjection(RootObjectDefinition, string, IObjectFactory)"/> 
		...
		/// <paramref name="definition"/> from the supplied <paramref name="factory"/>.
		/// </returns>
		/// <seealso cref="Oragon.Spring.Objects.Factory.Support.SimpleInstantiationStrategy.InstantiateWithMethodInjection(RootObjectDefinition, string, IObjectFactory, ConstructorInfo, object[])"/> 
		protected override object InstantiateWithMethodInjection(
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Support.IMethodReplacer"/>) into
		...
		private sealed class MethodInjectingTypeBuilder
		{
            ...
            */
			...
			/// <see cref="Oragon.Spring.Objects.Factory.Support.IMethodReplacer.Implement(object, MethodInfo, object[])"/>
