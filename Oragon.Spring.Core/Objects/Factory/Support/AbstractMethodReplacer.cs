...
{
	/// <summary>
	/// An <see cref="Oragon.Spring.Objects.Factory.Support.IMethodReplacer"/>
	...
	/// not intended to be used by application developers using Oragon.Spring.NET.
	/// </p>
	/// </remarks>
	...
	public abstract class AbstractMethodReplacer : IMethodReplacer
	{
		...
		/// <see cref="Oragon.Spring.Objects.Factory.Support.MethodOverride"/> for the
