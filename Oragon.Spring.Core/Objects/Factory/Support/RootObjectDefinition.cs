...
namespace Oragon.Spring.Objects.Factory.Support
{
    ...
    /// <see cref="Oragon.Spring.Objects.Factory.Support.RootObjectDefinition"/> instances
    /// do not derive from a parent
    /// <see cref="Oragon.Spring.Objects.Factory.Config.IObjectDefinition"/>, and usually
    /// (but not always - see below) have an
    /// <see cref="Oragon.Spring.Objects.Factory.Support.AbstractObjectDefinition.ObjectType"/>
    /// and (optionally) some
    /// <see cref="Oragon.Spring.Objects.Factory.Config.ConstructorArgumentValues"/> and
    /// <see cref="Oragon.Spring.Objects.IPropertyValues"/>.
    /// </p>
    /// <p>
    /// Note that <see cref="Oragon.Spring.Objects.Factory.Support.RootObjectDefinition"/>
    /// instances do not have to specify an
    /// <see cref="Oragon.Spring.Objects.Factory.Support.AbstractObjectDefinition.ObjectType"/> :
    /// This can be useful for deriving
    /// <see cref="Oragon.Spring.Objects.Factory.Support.ChildObjectDefinition"/> instances
    ...
    /// <seealso cref="Oragon.Spring.Objects.Factory.Support.ChildObjectDefinition"/>
    [Serializable]
