...
namespace Oragon.Spring.Aop.Support
{
    ...
    public class DefaultIntroductionAdvisorTests
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => new DefaultIntroductionAdvisor(new TestIntroductionAdvice(), GetType()), "Type [Oragon.Spring.Aop.Support.DefaultIntroductionAdvisorTests] is not an interface; cannot be used in an introduction.");
        }
