...
{
	/// <summary>
	/// Test introduction ported from Oragon.Spring.Java.
	/// </summary>
	/// <remarks>
	/// The name is deceptive because it isn't implemented as an interceptor.
	/// It's an introduction which is handled differently in Oragon.Spring.NET.
	/// Keeping the name is useful as a placeholder for future porting work.
	/// </remarks>
	/// <author>Oragon.Spring.Java Folks</author>
