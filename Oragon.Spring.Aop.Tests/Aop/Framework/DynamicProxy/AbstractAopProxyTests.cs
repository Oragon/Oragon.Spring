...
using Oragon.Spring.Aop.Interceptor;
    ...
    public abstract class AbstractAopProxyTests
    {
        ...
        private object SerializeAndDeserialize(object s)
        {
            ...
            using (Stream stream = new MemoryStream())
            {
                ...
                //formatter.AssemblyFormat = System.Runtime.Serialization.Formatters::System.Runtime.Serialization.Formatters.FormatterAssemblyStyle.Full;
        ...
        public void Does_proxy_interfacemethods_without_implementation_and_throws_NotSupportedException_On_Incompatible_Target()
        {
            ...
            invocationInterceptor.CallProceed = true;
            Assert.Throws<NotSupportedException>(() => proxy.GetDescription(), "Target 'target' of type 'System.Object' does not support methods of 'Oragon.Spring.Objects.ITestObject'.");
        }
        ...
        public void NoInterceptorWithNoTarget()
        {
            ...
            Assert.Throws<NotSupportedException>(() => to.GetDescription(), "Target 'target' of type 'System.Object' does not support methods of 'Oragon.Spring.Objects.ITestObject'.");
        }
        ...
        public void ProxyTargetMethodAttributes()
        {
            ...
            MethodInfo method = proxy.GetType().GetMethod("Oragon.Spring.Aop.Framework.DynamicProxy.AbstractAopProxyTests+IMarkerInterface.MarkerMethod", BindingFlags.NonPublic | BindingFlags.Instance);
            if (method == null)
            {
