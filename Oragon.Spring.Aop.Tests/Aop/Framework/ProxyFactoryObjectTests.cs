...
using Rhino.Mocks;
using Oragon.Spring.Aop.Advice;
...
//            using(mocks.Playback())
        ...
        public void NotAccessibleInterfaceProxying()
        {
                ...
                <object id='MyProxy' type='Oragon.Spring.Aop.Framework.ProxyFactoryObject, Oragon.Spring.Aop'>
                    <property name='ProxyInterfaces'>
                        <list>
                            <value>Oragon.Spring.Aop.Framework.HelperInterface2, Oragon.Spring.Aop.Tests</value>
                        </list>
                    </property>
                ...
                <object id='MyTarget' type='Oragon.Spring.Aop.Framework.HelperClassForNotAccessibleInterfaceProxyingTest, Oragon.Spring.Aop.Tests'/>
	            <object id='MyInterceptor' type='Oragon.Spring.Aop.Interceptor.NopInterceptor'/>
               </objects>";
